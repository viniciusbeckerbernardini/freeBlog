...
! function(t) {
    t.en = Object.assign(t.en || {}, {
        ...
        e: "Full size image",
        f: "Side image",
        g: "Left aligned image",
        h: "Centered image",
        i: "Right aligned image",
        j: "image widget",
        k: "Insert image or file",
        l: "Insert image",
        m: "Choose heading",
        n: "Heading",
        o: "Numbered List",
        ...
        aq: "Could not obtain resized image URL.",
        ar: "Selecting resized image failed",
        as: "Could not insert image at the current position.",
        at: "Inserting image failed",
        au: "Change image text alternative",
        av: "Paragraph",
        aw: "Heading 1",
        ax: "Heading 2",
        ay: "Heading 3",
        ...
        be: "Redo",
        bf: "Media URL",
        bg: "Paste the URL into the content to embed faster.",
        bh: "Link URL",
        bi: "Unlink",
        bj: "Edit link",
        bk: "Open link in new tab",
        bl: "This link has no URL",
...
function(t, e) {
    ...
    return function(t) {
        ...
        t.exports = ".ck-content .media{clear:both;margin:1em 0}"
    }, function(t, e, n) {
        var i = n(112);
        "string" == typeof i && (i = [
            [t.i, i, ""]
        ...
        var R = {
            ...
            fire(t, ...e) {
                const n = t instanceof S ? t : new S(this, t),
                    i = n.name;
                ...
                if (n.path.push(this), o) {
                    const t = [n, ...e];
                    o = Array.from(o);
                    for (let e = 0; e < o.length && (o[e].callback.apply(this, t), n.off.called && (delete n.off.called, B(this, i, o[e].callback)), !n.stop.called); e++);
                }
            ...
            delegate(...t) {
                return {
                    to: (e, n) => {
                        ...
                        for (const i of t) {
                            const t = this._delegations.get(i);
                            t ? t.set(e, n) : this._delegations.set(i, new Map([
                                [e, n]
                            ]))
                        }
                    }
        ...
        K.prototype.clear = H, K.prototype.delete = $, K.prototype.get = G, K.prototype.has = Q, K.prototype.set = J;
        var Z = K;
        var X = function() {
        ...
        var ct = function(t) {
                if (!it(t)) return !1;
                var e = p(t);
                return e == rt || e == st || e == ot || e == at
            },
            lt = i.a["__core-js_shared__"],
            dt = function() {
        ...
        var ft = function(t) {
            ...
            _t = RegExp("^" + bt.call(wt).replace(/[\\^$.*+?()[\]{}|]/g, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$");
        var kt = function(t) {
            return !(!it(t) || ut(t)) && (ct(t) ? _t : mt).test(ft(t))
        };
        var vt = function(t, e) {
        ...
        Rt.prototype.clear = Ct, Rt.prototype.delete = Tt, Rt.prototype.get = St, Rt.prototype.has = Et, Rt.prototype.set = Ot;
        var Dt = Rt;
        var Lt = function() {
        ...
        Ht.prototype.clear = Lt, Ht.prototype.delete = zt, Ht.prototype.get = Bt, Ht.prototype.has = Ft, Ht.prototype.set = Ut;
        var qt = Ht,
            Wt = 200;
        var Yt = function(t, e) {
            var n = this.__data__;
            if (n instanceof Z) {
                var i = n.__data__;
                if (!xt || i.length < Wt - 1) return i.push([t, e]), this.size = ++n.size, this;
        ...
        $t.prototype.clear = X, $t.prototype.delete = tt, $t.prototype.get = et, $t.prototype.has = nt, $t.prototype.set = Yt;
        var Gt = $t;
        var Qt = function(t, e) {
        ...
        var Xt = function(t, e, n) {
            var i = t[e];
            Zt.call(t, e) && q(i, n) && (void 0 !== n || e in t) || Kt(t, e, n)
        };
        var te = function(t, e, n, i) {
            ...
            for (var r = -1, s = e.length; ++r < s;) {
                ...
                void 0 === c && (c = t[a]), o ? Kt(n, a, c) : Xt(n, a, c)
            }
            return n
        };
        var ee = function(t, e) {
        ...
        var ye = function(t, e) {
                var n = ce(t),
                    ...
                    c = a.length;
                for (var l in t) !e && !ve.call(t, l) || s && ("length" == l || o && ("offset" == l || "parent" == l) || r && ("buffer" == l || "byteLength" == l || "byteOffset" == l) || he(l, c)) || a.push(l);
                return a
            },
            xe = Object.prototype;
        var Ae = function(t) {
        ...
        var Oe = function(t) {
            ...
            var e = Ae(t),
                n = [];
            for (var i in t)("constructor" != i || !e && Ne.call(t, i)) && n.push(i);
            return n
        };
        var Re = function(t) {
            return Me(t) ? ye(t, !0) : Oe(t)
        };
        var De = function(t, e) {
        ...
        var ze = function() {
            ...
            Ue = Fe ? function(t) {
                return null == t ? [] : (t = Object(t), Ve(Fe(t), function(e) {
                    return Be.call(t, e)
                }))
            } : ze;
        var He = function(t, e) {
        ...
        var mn = function(t) {
            ...
            pn = o ? o.prototype : void 0,
            gn = pn ? pn.valueOf : void 0;
        var bn = function(t) {
        ...
        var Fn = function(t) {
                return "function" != typeof t.constructor || Ae(t) ? {} : Bn(b(t))
            },
            Un = "[object Map]";
        var Hn = function(t) {
                return w(t) && an(t) == Un
        ...
        var $n = function(t) {
            ...
            ni = "[object Object]",
            ii = {};
        ii[Xn] = ii["[object Array]"] = ii["[object ArrayBuffer]"] = ii["[object DataView]"] = ii["[object Boolean]"] = ii["[object Date]"] = ii["[object Float32Array]"] = ii["[object Float64Array]"] = ii["[object Int8Array]"] = ii["[object Int16Array]"] = ii["[object Int32Array]"] = ii["[object Map]"] = ii["[object Number]"] = ii[ni] = ii["[object RegExp]"] = ii["[object Set]"] = ii["[object String]"] = ii["[object Symbol]"] = ii["[object Uint8Array]"] = ii["[object Uint8ClampedArray]"] = ii["[object Uint16Array]"] = ii["[object Uint32Array]"] = !0, ii["[object Error]"] = ii[ti] = ii["[object WeakMap]"] = !1;
        var oi = function t(e, n, i, o, r, s) {
                var a, c = n & Jn,
                    l = n & Kn,
                    d = n & Zn;
                ...
                if (u) {
                    ...
                    if (h == ni || h == Xn || f && !r) {
                        if (a = l || f ? {} : Fn(e), !c) return l ? Ye(e, De(a, e)) : He(e, Ie(a, e))
                    } else {
                        if (!ii[h]) return r ? e : {};
                        a = Vn(e, h, c)
                    }
                ...
                var m = s.get(e);
                if (m) return m;
                if (s.set(e, a), Qn(e)) return e.forEach(function(o) {
                    a.add(t(o, n, i, o, e, s))
                }), a;
                if (Wn(e)) return e.forEach(function(o, r) {
                    a.set(r, t(o, n, i, r, e, s))
                }), a;
                var p = d ? l ? Qe : Ge : l ? keysIn : Se,
                    g = u ? void 0 : p(e);
                return Qt(g || e, function(o, r) {
                    g && (o = e[r = o]), Xt(a, r, t(o, n, i, r, e, s))
                }), a
            },
            ri = 4;
        var si = function(t) {
        ...
        class ai {
            ...
            get index() {
                ...
                if (-1 == (t = this.parent.getChildIndex(this))) throw new P.b("view-node-not-found-in-parent: The node's parent does not contain this node.");
                return t
            }
            get nextSibling() {
                const t = this.index;
            ...
            get document() {
                return this.parent instanceof ai ? this.parent.document : null
            }
            getPath() {
                const t = [];
                let e = this;
        ...
        class ci extends ai {
            ...
            isSimilar(t) {
                return t instanceof ci && (this === t || this.data === t.data)
            }
            _clone() {
                return new ci(this.data)
            }
        }
        class li {
            constructor(t, e, n) {
                if (this.textNode = t, e < 0 || e > t.data.length) throw new P.b("view-textproxy-wrong-offsetintext: Given offsetInText value is incorrect.");
                if (n < 0 || e + n > t.data.length) throw new P.b("view-textproxy-wrong-length: Given length value is incorrect.");
        ...
        class mi extends ai {
            constructor(t, e, n) {
                if (super(), this.name = t, this._attrs = function(t) {
                    ...
                    gi(this._classes, t), this._attrs.delete("class")
                }
                this._styles = new Map, this._attrs.has("style") && (pi(this._styles, this._attrs.get("style")), this._attrs.delete("style")), this._customProperties = new Map
            }
            get childCount() {
            ...
            _insertChild(t, e) {
                ...
                let n = 0;
                const i = function(t) {
                    if ("string" == typeof t) return [new ci(t)];
                    ui(t) || (t = [t]);
                    return Array.from(t).map(t => "string" == typeof t ? new ci(t) : t instanceof li ? new ci(t.data) : t)
                }(e);
            ...
            _setAttribute(t, e) {
                e = String(e), this._fireChange("attributes", this), "class" == t ? gi(this._classes, e) : "style" == t ? pi(this._styles, e) : this._attrs.set(t, e)
            }
            _removeAttribute(t) {
            ...
            if (t.clear(), "" !== e) {
                ...
                for (let s = 0; s < e.length; s++) {
                    ...
                    if (null === n) switch (a) {
                        ...
                        case ";":
                            {
                                const n = e.substr(o, s - o);r && t.set(r.trim(), n.trim()),
                                r = null,
                                i = s + 1;
                                break
                            }
        ...
        var yi = function(t, e, n) {
            return e = vi(void 0 === e ? t.length - 1 : e, 0),
                function() {
                    for (var i = arguments, o = -1, r = vi(i.length - e, 0), s = Array(r); ++o < r;) s[o] = i[e + o];
                    o = -1;
                    for (var a = Array(e + 1); ++o < e;) a[o] = i[o];
                    return a[e] = n(s), ki(t, this, a)
                }
        };
        var xi = function(t) {
                return function() {
        ...
        var Mi = function(t) {
            ...
            return function() {
                var i = Pi(),
                    o = Ti - (i - n);
                if (n = i, o > 0) {
                    if (++e >= Ci) return arguments[0]
                } else e = 0;
                return t.apply(void 0, arguments)
            }
        }(Ai);
        var Si = function(t, e) {
            return Mi(yi(t, e, _i), t + "")
        };
        var Ii = function(t, e, n) {
            if (!it(n)) return !1;
            var i = typeof e;
            return !!("number" == i ? Me(n) && he(e, n.length) : "string" == i && e in n) && q(n[e], t)
        };
        var Ei = function(t) {
            return Si(function(e, n) {
                var i = -1,
                    ...
                    r = o > 1 ? n[o - 1] : void 0,
                    s = o > 2 ? n[2] : void 0;
                for (r = t.length > 3 && "function" == typeof r ? (o--, r) : void 0, s && Ii(n[0], n[1], s) && (r = o < 3 ? void 0 : r, o = 1), e = Object(e); ++i < o;) {
                    var a = n[i];
                    a && t(e, a, i, r)
                }
                return e
        ...
        const Ni = Symbol("observableProperties"),
            Oi = Symbol("boundObservables"),
            Ri = Symbol("boundProperties"),
            Di = {
                set(t, e) {
                    if (it(t)) return void Object.keys(t).forEach(e => {
                        this.set(e, t[e])
                    }, this);
                    ji(this);
                    const n = this[Ni];
                    if (t in this && !n.has(t)) throw new P.b("observable-set-cannot-override: Cannot override an existing property.");
                ...
                bind(...t) {
                    if (!t.length || !Bi(t)) throw new P.b("observable-bind-wrong-properties: All properties must be strings.");
                    if (new Set(t).size !== t.length) throw new P.b("observable-bind-duplicate-properties: Properties must be unique.");
                    ji(this);
                    const e = this[Ri];
                    t.forEach(t => {
                        if (e.has(t)) throw new P.b("observable-bind-rebind: Cannot bind the same property more that once.")
                    });
                    const n = new Map;
                    return t.forEach(t => {
                        const i = {
                ...
                unbind(...t) {
                    if (!(Ni in this)) return;
                    const e = this[Ri],
                        n = this[Oi];
                    if (t.length) {
                        if (!Bi(t)) throw new P.b("observable-unbind-wrong-properties: Properties must be strings.");
                        t.forEach(t => {
                            const i = e.get(t);
                            if (!i) return;
                            let o, r, s, a;
                ...
                decorate(t) {
                    const e = this[t];
                    if (!e) throw new P.b("observablemixin-cannot-decorate-undefined: Cannot decorate an undefined method.", {
                        object: this,
                        methodName: t
                    });
                    this.on(t, (t, n) => {
        ...
        function ji(t) {
            Ni in t || (Object.defineProperty(t, Ni, {
                value: new Map
        ...
        function Vi(...t) {
            const e = function(...t) {
                    if (!t.length) throw new P.b("observable-bind-to-parse-error: Invalid argument syntax in `to()`.");
                    const e = {
                        to: []
                    };
                    let n;
                    ...
                    return t.forEach(t => {
                        if ("string" == typeof t) n.properties.push(t);
                            ...
                            if ("object" != typeof t) throw new P.b("observable-bind-to-parse-error: Invalid argument syntax in `to()`.");
                            n = {
                                observable: t,
                                properties: []
                            }, e.to.push(n)
                ...
                i = n.length;
            if (!e.callback && e.to.length > 1) throw new P.b("observable-bind-to-no-callback: Binding multiple observables only possible with callback.");
            if (i > 1 && e.callback) throw new P.b("observable-bind-to-extra-callback: Cannot bind multiple properties and use a callback in one binding.");
            e.to.forEach(t => {
                    if (t.properties.length && t.properties.length !== i) throw new P.b("observable-bind-to-properties-length: The number of properties must match.");
                ...
                function(t) {
                    ...
                    Fi(this._observable, t)
                })
        }

        function zi(t, e, n) {
            if (this._bindings.size > 1) throw new P.b("observable-bind-to-many-not-one-binding: Cannot bind multiple properties with toMany().");
        ...
        class Hi extends bi {
            ...
            get document() {
                return this.getCustomProperty(Ui)
            }
            set _document(t) {
                if (this.getCustomProperty(Ui)) throw new P.b("view-editableelement-document-already-set: View document is already set.");
                this._setCustomProperty(Ui, t), this.bind("isReadOnly").to(t), this.bind("isFocused").to(t, "isFocused", e => e && t.selection.editableElement == this), this.listenTo(t.selection, "change", () => {
        ...
        class Yi {
            constructor(t = {}) {
                if (!t.boundaries && !t.startPosition) throw new P.b("view-tree-walker-no-start-position: Neither boundaries nor starting position have been defined.");
                if (t.direction && "forward" != t.direction && "backward" != t.direction) throw new P.b("view-tree-walker-unknown-direction: Only `backward` and `forward` direction allowed.", {
                    direction: t.direction
                });
                this.boundaries = t.boundaries || null, t.startPosition ? this.position = $i._createAt(t.startPosition) : this.position = $i._createAt(t.boundaries["backward" == t.direction ? "end" : "start"]), this.direction = t.direction || "forward", this.singleCharacters = !!t.singleCharacters, this.shallow = !!t.shallow, this.ignoreElementEnd = !!t.ignoreElementEnd, this._boundaryStartParent = this.boundaries ? this.boundaries.start.parent : null, this._boundaryEndParent = this.boundaries ? this.boundaries.end.parent : null
            } [Symbol.iterator]() {
                return this
            }
            skip(t) {
            ...
            _next() {
                ...
                let i;
                if (n instanceof ci) {
                    if (t.isAtEnd) return this.position = $i._createAfter(n), this._next();
                    i = n.data[t.offset]
                } else i = n.getChild(t.offset);
                if (i instanceof mi) return this.shallow ? t.offset++ : t = new $i(i, 0), this.position = t, this._formatReturnValue("elementStart", i, e, t, 1);
                if (i instanceof ci) {
                    if (this.singleCharacters) return t = new $i(i, 0), this.position = t, this._next(); {
                        let n, o = i.data.length;
                        return i == this._boundaryEndParent ? (o = this.boundaries.end.offset, n = new li(i, 0, o), t = $i._createAfter(n)) : (n = new li(i, 0, i.data.length), t.offset++), this.position = t, this._formatReturnValue("text", n, e, t, o)
                    }
                }
                if ("string" == typeof i) {
                    let i;
                    ...
                    const o = new li(n, t.offset, i);
                    return t.offset += i, this.position = t, this._formatReturnValue("text", o, e, t, i)
                }
                return t = $i._createAfter(n), this.position = t, this.ignoreElementEnd ? this._next() : this._formatReturnValue("elementEnd", n, e, t)
            }
            _previous() {
                let t = this.position.clone();
                const e = this.position,
                ...
                let i;
                if (n instanceof ci) {
                    if (t.isAtStart) return this.position = $i._createBefore(n), this._previous();
                    i = n.data[t.offset - 1]
                } else i = n.getChild(t.offset - 1);
                if (i instanceof mi) return this.shallow ? (t.offset--, this.position = t, this._formatReturnValue("elementStart", i, e, t, 1)) : (t = new $i(i, i.childCount), this.position = t, this.ignoreElementEnd ? this._previous() : this._formatReturnValue("elementEnd", i, e, t));
                if (i instanceof ci) {
                    if (this.singleCharacters) return t = new $i(i, i.data.length), this.position = t, this._previous(); {
                        let n, o = i.data.length;
                        if (i == this._boundaryStartParent) {
                            const e = this.boundaries.start.offset;
                            o = (n = new li(i, e, i.data.length - e)).data.length, t = $i._createBefore(n)
                        } else n = new li(i, 0, i.data.length), t.offset--;
                ...
                return t = $i._createBefore(n), this.position = t, this._formatReturnValue("elementStart", n, e, t, 1)
            }
            _formatReturnValue(t, e, n, i, o) {
                return e instanceof li && (e.offsetInText + e.data.length == e.textNode.data.length && ("forward" != this.direction || this.boundaries && this.boundaries.end.isEqual(this.position) ? n = $i._createAfter(e.textNode) : (i = $i._createAfter(e.textNode), this.position = i)), 0 === e.offsetInText && ("backward" != this.direction || this.boundaries && this.boundaries.start.isEqual(this.position) ? n = $i._createBefore(e.textNode) : (i = $i._createBefore(e.textNode), this.position = i))), {
                    done: !1,
                    value: {
                        type: t,
                        item: e,
        ...
        class $i {
            ...
            getWalker(t = {}) {
                return t.startPosition = this, new Yi(t)
            }
            clone() {
                return new $i(this.parent, this.offset)
            }
            static _createAt(t, e) {
                if (t instanceof $i) return new this(t.parent, t.offset); {
                    const n = t;
                    if ("end" == e) e = n.is("text") ? n.data.length : n.childCount;
                        ...
                        if (0 !== e && !e) throw new P.b("view-createPositionAt-offset-required: View#createPositionAt() requires the offset when the first parameter is a view item.")
                    }
                    return new $i(n, e)
                }
            }
            static _createAfter(t) {
                if (t.is("textProxy")) return new $i(t.textNode, t.offsetInText + t.data.length);
                if (!t.parent) throw new P.b("view-position-after-root: You can not make position after root.", {
                    root: t
                });
                return new $i(t.parent, t.index + 1)
            }
            static _createBefore(t) {
                if (t.is("textProxy")) return new $i(t.textNode, t.offsetInText);
                if (!t.parent) throw new P.b("view-position-before-root: You can not make position before root.", {
                    root: t
                });
                return new $i(t.parent, t.index)
            }
        }
        class Gi {
            ...
            getEnlarged() {
                let t = this.start.getLastMatchingPosition(Qi, {
                        direction: "backward"
                    }),
                    e = this.end.getLastMatchingPosition(Qi);
                return t.parent.is("text") && t.isAtStart && (t = $i._createBefore(t.parent)), e.parent.is("text") && e.isAtEnd && (e = $i._createAfter(e.parent)), new Gi(t, e)
            }
            getTrimmed() {
                let t = this.start.getLastMatchingPosition(Qi);
                if (t.isAfter(this.end) || t.isEqual(this.end)) return new Gi(t, t);
                let e = this.end.getLastMatchingPosition(Qi, {
                    direction: "backward"
                });
                const n = t.nodeAfter,
                    i = e.nodeBefore;
                return n && n.is("text") && (t = new $i(n, 0)), i && i.is("text") && (e = new $i(i, i.data.length)), new Gi(t, e)
            }
            isEqual(t) {
            ...
            getDifference(t) {
                const e = [];
                return this.isIntersecting(t) ? (this.containsPosition(t.start) && e.push(new Gi(this.start, t.start)), this.containsPosition(t.end) && e.push(new Gi(t.end, this.end))) : e.push(this.clone()), e
            }
            getIntersection(t) {
                if (this.isIntersecting(t)) {
                    let e = this.start,
                        n = this.end;
                    return this.containsPosition(t.start) && (e = t.start), this.containsPosition(t.end) && (n = t.end), new Gi(e, n)
                }
                return null
            }
            getWalker(t = {}) {
                return t.boundaries = this, new Yi(t)
            }
            getCommonAncestor() {
                return this.start.getCommonAncestor(this.end)
            }
            clone() {
                return new Gi(this.start, this.end)
            }* getItems(t = {}) {
            ...
            static _createFromParentsAndOffsets(t, e, n, i) {
                return new this(new $i(t, e), new $i(n, i))
            }
            ...
            static _createOn(t) {
                ...
                return this._createFromPositionAndShift($i._createBefore(t), e)
            }
        }
        ...
        class Ki {
            ...
            isSimilar(t) {
                ...
                const e = Ji(this.getRanges());
                if (e != Ji(t.getRanges())) return !1;
                if (0 == e) return !0;
            ...
            getSelectedElement() {
                ...
                const t = this.getFirstRange(),
                    e = t.start.nodeAfter,
                    n = t.end.nodeBefore;
                return e instanceof mi && e == n ? e : null
            }
            setTo(t, e, n) {
                if (null === t) this._setRanges([]), this._setFakeOptions(e);
                else if (t instanceof Ki || t instanceof Zi) this._setRanges(t.getRanges(), t.isBackward), this._setFakeOptions({
                    fake: t.isFake,
                    label: t.fakeSelectionLabel
                });
                else if (t instanceof Gi) this._setRanges([t], e && e.backward), this._setFakeOptions(e);
                else if (t instanceof $i) this._setRanges([new Gi(t)]), this._setFakeOptions(e);
                else if (t instanceof ai) {
                    const i = !!n && !!n.backward;
                    let o;
                    if (void 0 === e) throw new P.b("view-selection-setTo-required-second-parameter: selection.setTo requires the second parameter when the first parameter is a node.");
                    o = "in" == e ? Gi._createIn(t) : "on" == e ? Gi._createOn(t) : new Gi($i._createAt(t, e)), this._setRanges([o], i), this._setFakeOptions(n)
                } else {
                    if (!ui(t)) throw new P.b("view-selection-setTo-not-selectable: Cannot set selection to given place.");
                    this._setRanges(t, e && e.backward), this._setFakeOptions(e)
                }
                this.fire("change")
            }
            setFocus(t, e) {
                if (null === this.anchor) throw new P.b("view-selection-setFocus-no-ranges: Cannot set selection focus if there are no ranges in selection.");
                const n = $i._createAt(t, e);
                if ("same" == n.compareWith(this.focus)) return;
                const i = this.anchor;
                this._ranges.pop(), "before" == n.compareWith(i) ? this._addRange(new Gi(n, i), !0) : this._addRange(new Gi(i, n)), this.fire("change")
            }
            _setRanges(t, e = !1) {
            ...
            _addRange(t, e = !1) {
                if (!(t instanceof Gi)) throw new P.b("view-selection-add-range-not-range: Selection range set to an object that is not an instance of view.Range");
                this._pushRange(t), this._lastRangeBackward = !!e
            }
            _pushRange(t) {
                for (const e of this._ranges)
                    if (t.isIntersecting(e)) throw new P.b("view-selection-range-intersects: Trying to add a range that intersects with another range from selection.", {
                        addedRange: t,
                        intersectingRange: e
                    });
                this._ranges.push(new Gi(t.start, t.end))
            }
        }
        F(Ki, R);
        class Zi {
            constructor(t = null, e, n) {
                this._selection = new Ki, this._selection.delegate("change").to(this), this._selection.setTo(t, e, n)
            }
            get isFake() {
        ...
        class Xi {
            ...
            add(t, e) {
                ...
                if (i in t) {
                    if ("string" != typeof(n = t[i])) throw new P.b("collection-add-invalid-id");
                    if (this.get(n)) throw new P.b("collection-add-item-already-exists")
                } else t[i] = n = I();
                if (void 0 === e) e = this._items.length;
                else if (e > this._items.length || e < 0) throw new P.b("collection-add-item-invalid-index");
            ...
            get(t) {
                ...
                if ("string" == typeof t) e = this._itemMap.get(t);
                    ...
                    if ("number" != typeof t) throw new P.b("collection-get-invalid-arg: Index or id must be given.");
                    e = this._items[t]
                }
                return e || null
            }
            ...
            remove(t) {
                ...
                if ("string" == typeof t ? (n = t, o = !(i = this._itemMap.get(n)), i && (e = this._items.indexOf(i))) : "number" == typeof t ? (e = t, o = !(i = this._items[e]), i && (n = i[r])) : (n = (i = t)[r], o = -1 == (e = this._items.indexOf(i)) || !this._itemMap.get(n)), o) throw new P.b("collection-remove-404: Item not found.");
            ...
            bindTo(t) {
                if (this._bindToCollection) throw new P.b("collection-bind-to-rebind: The collection cannot be bound more than once.");
        ...
        class to {
            constructor() {
                this.selection = new Zi, this.roots = new Xi({
                    idProperty: "rootName"
        ...
        class no extends mi {
            constructor(t, e, n) {
                super(t, e, n), this.getFillerOffset = io, this._priority = eo, this._id = null, this._clonesGroup = null
            }
            get priority() {
            ...
            getElementsWithSameId() {
                if (null === this.id) throw new P.b("attribute-element-get-elements-with-same-id-no-id: Cannot get elements with the same id for an attribute element without id.");
        ...
        function io() {
            if (oo(this)) return null;
            let t = this.parent;
            for (; t && t.is("attributeElement");) {
                if (oo(t) > 1) return null;
                t = t.parent
            }
            return !t || oo(t) > 1 ? null : this.childCount
        }

        function oo(t) {
            return Array.from(t.getChildren()).filter(t => !t.is("uiElement")).length
        }
        no.DEFAULT_PRIORITY = eo;
        class ro extends mi {
            constructor(t, e, n) {
                super(t, e, n), this.getFillerOffset = so
            }
            is(t, e = null) {
                return e ? "emptyElement" == t && e == this.name || super.is(t, e) : "emptyElement" == t || super.is(t)
            }
            _insertChild(t, e) {
                if (e && (e instanceof ai || Array.from(e).length > 0)) throw new P.b("view-emptyelement-cannot-add: Cannot add child nodes to EmptyElement instance.")
            }
        }
        ...
        const ao = navigator.userAgent.toLowerCase();
        var co = {
            isMac: function(t) {
        ...
        function fo(t) {
            let e;
            if ("string" == typeof t) {
                if (!(e = ho[t.toLowerCase()])) throw new P.b("keyboard-unknown-key: Unknown key name.", {
                    key: t
                })
            } else e = t.keyCode + (t.altKey ? ho.alt : 0) + (t.ctrlKey ? ho.ctrl : 0) + (t.shiftKey ? ho.shift : 0);
            return e
        }

        function mo(t) {
            return "string" == typeof t && (t = po(t)), t.map(t => "string" == typeof t ? fo(t) : t).reduce((t, e) => e + t, 0)
        }
        ...
        class go extends mi {
            constructor(t, e, n) {
                super(t, e, n), this.getFillerOffset = wo
            }
            is(t, e = null) {
                return e ? "uiElement" == t && e == this.name || super.is(t, e) : "uiElement" == t || super.is(t)
            }
            _insertChild(t, e) {
                if (e && (e instanceof ai || Array.from(e).length > 0)) throw new P.b("view-uielement-cannot-add: Cannot add child nodes to UIElement instance.")
            }
            render(t) {
        ...
        class ko {
            ...
            breakAttributes(t) {
                return t instanceof $i ? this._breakAttributes(t) : this._breakAttributesRange(t)
            }
            breakContainer(t) {
                const e = t.parent;
                if (!e.is("containerElement")) throw new P.b("view-writer-break-non-container-element: Trying to break an element which is not a container element.");
                if (!e.parent) throw new P.b("view-writer-break-root: Trying to break root element.");
                if (t.isAtStart) return $i._createBefore(e);
                if (!t.isAtEnd) {
                    const n = e._clone(!1);
                    this.insert($i._createAfter(e), n);
                    const i = new Gi(t, $i._createAt(e, "end")),
                        o = new $i(n, 0);
                    this.move(i, o)
                }
                return $i._createAfter(e)
            }
            mergeAttributes(t) {
                const e = t.offset,
                    n = t.parent;
                ...
                if (n.is("attributeElement") && 0 === n.childCount) {
                    const t = n.parent,
                        e = n.index;
                    return n._remove(), this._removeFromClonedElementsGroup(n), this.mergeAttributes(new $i(t, e))
                }
                const i = n.getChild(e - 1),
                    o = n.getChild(e);
                if (!i || !o) return t;
                if (i.is("text") && o.is("text")) return Co(i, o);
                if (i.is("attributeElement") && o.is("attributeElement") && i.isSimilar(o)) {
                    const t = i.childCount;
                    return i._appendChild(o.getChildren()), o._remove(), this._removeFromClonedElementsGroup(o), this.mergeAttributes(new $i(i, t))
                }
                return t
            }
            mergeContainers(t) {
                const e = t.nodeBefore,
                    n = t.nodeAfter;
                if (!(e && n && e.is("containerElement") && n.is("containerElement"))) throw new P.b("view-writer-merge-containers-invalid-position: Element before and after given position cannot be merged.");
                const i = e.getChild(e.childCount - 1),
                    o = i instanceof ci ? $i._createAt(i, "end") : $i._createAt(e, "end");
                return this.move(Gi._createIn(n), $i._createAt(e, "end")), this.remove(Gi._createOn(n)), o
            }
            insert(t, e) {
                (function t(e) {
                    for (const n of e) {
                        if (!To.some(t => n instanceof t)) throw new P.b("view-writer-insert-invalid-node");
                        n.is("text") || t(n.getChildren())
                    }
                })(e = ui(e) ? [...e] : [e]);
                const n = vo(t);
                if (!n) throw new P.b("view-writer-invalid-position-container");
            ...
            remove(t) {
                const e = t instanceof Gi ? t : Gi._createOn(t);
                if (Mo(e), e.isCollapsed) return new _o;
                const {
                    start: n,
                    end: i
                ...
                return e.start = a, e.end = a.clone(), new _o(s)
            }
            clear(t, e) {
                Mo(t);
                const n = t.getWalker({
                ...
                for (const i of n) {
                    const n = i.item;
                    let o;
                    if (n.is("element") && e.isSimilar(n)) o = Gi._createOn(n);
            ...
            wrap(t, e) {
                if (!(e instanceof no)) throw new P.b("view-writer-wrap-invalid-attribute");
                if (Mo(t), t.isCollapsed) {
                    let n = t.start;
                    ...
                    return i.isCollapsed && i.getFirstPosition().isEqual(t.start) && this.setSelection(n), new Gi(n)
                }
                return this._wrapRange(t, e)
            }
            unwrap(t, e) {
                if (!(e instanceof no)) throw new P.b("view-writer-unwrap-invalid-attribute");
                if (Mo(t), t.isCollapsed) return t;
                const {
                    start: n,
                    end: i
                ...
                if (i.isEqual(n.getShiftedBy(1))) {
                    const t = n.nodeAfter;
                    if (!e.isSimilar(t) && t instanceof no && this._unwrapAttributeElement(e, t)) {
            ...
            rename(t, e) {
                const n = new bi(t, e.getAttributes());
                return this.insert($i._createAfter(e), n), this.move(Gi._createIn(e), $i._createAt(n, 0)), this.remove(Gi._createOn(e)), n
            }
            clearClonedElementsGroup(t) {
                this._cloneGroups.delete(t)
            }
            createPositionAt(t, e) {
                return $i._createAt(t, e)
            }
            createPositionAfter(t) {
                return $i._createAfter(t)
            }
            createPositionBefore(t) {
                return $i._createBefore(t)
            }
            createRange(t, e) {
                return new Gi(t, e)
            }
            createRangeOn(t) {
                return Gi._createOn(t)
            }
            createRangeIn(t) {
                return Gi._createIn(t)
            }
            ...
            _wrapChildren(t, e, n, i) {
                ...
                for (; o < n;) {
                    ...
                    if (n || a || c || s && yo(i, e)) {
                        const n = i._clone();
                        e._remove(), n._appendChild(e), t._insertChild(o, n), this._addToClonedElementsGroup(n), r.push(new $i(t, o))
                ...
                return Gi._createFromParentsAndOffsets(t, e, t, n)
            }
                ...
                for (; o < n;) {
                    ...
                    if (e.isSimilar(i)) {
                        const i = e.getChildren(),
                            s = e.childCount;
                        e._remove(), t._insertChild(o, i), this._removeFromClonedElementsGroup(e), r.push(new $i(t, o), new $i(t, o + s)), o += s, n += s - 1
            ...
            _wrapRange(t, e) {
                if (function(t) {
                    ...
                    const e = t.start.parent,
                        n = this.mergeAttributes($i._createAfter(e)),
                        i = this.mergeAttributes($i._createBefore(e));
                    return new Gi(i, n)
                }
                const {
                    start: n,
                ...
                if (i.isEqual(n.getShiftedBy(1))) {
                    const t = n.nodeAfter;
                    if (t instanceof no && this._wrapAttributeElement(e, t)) {
                        const t = this.mergeAttributes(n);
                        t.isEqual(n) || i.offset--;
                        const e = this.mergeAttributes(i);
                        return new Gi(t, e)
            ...
            _wrapPosition(t, e) {
                if (e.isSimilar(t.parent)) return xo(t.clone());
                t.parent.is("text") && (t = Ao(t));
                const n = this.createAttributeElement();
                n._priority = Number.POSITIVE_INFINITY, n.isSimilar = (() => !1), t.parent._insertChild(t.offset, n);
                const i = new Gi(t, t.getShiftedBy(1));
                this.wrap(i, e);
                const o = new $i(n.parent, n.index);
                n._remove();
                const r = o.nodeBefore,
                    s = o.nodeAfter;
                return r instanceof ci && s instanceof ci ? Co(r, s) : xo(o)
            }
            ...
            _breakAttributesRange(t, e = !1) {
                ...
                return o.offset += o.parent.childCount - r, new Gi(s, o)
            }
            _breakAttributes(t, e = !1) {
                const n = t.offset,
                    i = t.parent;
                if (t.parent.is("emptyElement")) throw new P.b("view-writer-cannot-break-empty-element");
                if (t.parent.is("uiElement")) throw new P.b("view-writer-cannot-break-ui-element");
                if (!e && i.is("text") && Po(i.parent)) return t.clone();
                if (Po(i)) return t.clone();
                if (i.is("text")) return this._breakAttributes(Ao(t), e);
                if (n == i.childCount) {
                    const t = new $i(i.parent, i.index + 1);
                    return this._breakAttributes(t, e)
                }
                if (0 === n) {
                    const t = new $i(i.parent, i.index);
                    return this._breakAttributes(t, e)
                } {
                    const t = i.index + 1,
                        o = i._clone();
        ...
        function xo(t) {
            const e = t.nodeBefore;
            if (e && e.is("text")) return new $i(e, e.data.length);
            const n = t.nodeAfter;
            return n && n.is("text") ? new $i(n, 0) : t
        }

        function Ao(t) {
            if (t.offset == t.parent.data.length) return new $i(t.parent.parent, t.parent.index + 1);
            if (0 === t.offset) return new $i(t.parent.parent, t.parent.index);
            const e = t.parent.data.slice(t.offset);
            return t.parent._data = t.parent.data.slice(0, t.offset), t.parent.parent._insertChild(t.parent.index + 1, new ci(e)), new $i(t.parent.parent, t.parent.index + 1)
        }

        function Co(t, e) {
            const n = t.data.length;
            return t._data += e.data, e._remove(), new $i(t, n)
        }
        const To = [ci, no, bi, ro, go];
        ...
        function Mo(t) {
            const e = vo(t.start),
                n = vo(t.end);
            if (!e || !n || e !== n) throw new P.b("view-writer-invalid-range-container")
        }
        ...
        const Eo = t => {
            ...
            No = t => t.createTextNode("Â "),
            Oo = 7;
        let Ro = "";
        for (let t = 0; t < Oo; t++) Ro += "â€‹";

        function Do(t) {
            return Io(t) && t.data.substr(0, Oo) === Ro
        }

        function Lo(t) {
            return t.data.length == Oo && Do(t)
        }

        function jo(t) {
            return Do(t) ? t.data.slice(Oo) : t.data
        }
        const Vo = new WeakMap;

        function zo(t, e) {
            let n = Vo.get(e);
            return n || (n = e(window.document), Vo.set(e, n)), t.isEqualNode(n)
        }
        ...
        function Fo(t, e, n) {
            ...
            if (n = n || function(t, e) {
                ...
                const n = t;
                t = e, e = n, i = "delete", o = "insert"
            } else i = "insert", o = "delete";
            const r = t.length,
                s = e.length,
                a = s - r,
                c = {},
            ...
            function d(a) {
                const d = (void 0 !== l[a - 1] ? l[a - 1] : -1) + 1,
                    ...
                    h = d > u ? -1 : 1;
                c[a + h] && (c[a] = c[a + h].slice(0)), c[a] || (c[a] = []), c[a].push(d > u ? i : o);
                let f = Math.max(d, u),
                    m = f - a;
        ...
        class Go {
            ...
            markToSync(t, e) {
                if ("text" === t) this.domConverter.mapViewToDom(e.parent) && this.markedTexts.add(e);
                    ...
                    if ("attributes" === t) this.markedAttributes.add(e);
                        ...
                        if ("children" !== t) throw new P.b("view-renderer-unknown-type: Unknown type passed to Renderer.markToSync.");
            ...
            render() {
                ...
                if (t) {
                    ...
                    Do(e.parent) ? this._inlineFiller = e.parent : this._inlineFiller = Qo(n, e.parent, e.offset)
                    ...
                    for (const o of r)
                        if ("replace" === o) {
                            const o = e.equal + e.insert,
                                r = e.equal + e.delete,
                                s = t.getChild(o);
                            s && !s.is("uiElement") && this._updateElementMappings(s, n[r]), Ho(i[o]), e.equal++
                        } else e[o]++
                }
            }
            ...
            _getInlineFillerPosition() {
                ...
                return t.parent.is("text") ? $i._createBefore(this.selection.getFirstPosition().parent) : t
            }
            _isSelectionInInlineFiller() {
                if (1 != this.selection.rangeCount || !this.selection.isCollapsed) return !1;
                const t = this.selection.getFirstPosition(),
                    e = this.domConverter.viewPositionToDom(t);
                return !!(e && Io(e.parent) && Do(e.parent))
            }
            _removeInlineFiller() {
                const t = this._inlineFiller;
                if (!Do(t)) throw new P.b("view-renderer-filler-was-lost: The inline filler node was lost.");
                Lo(t) ? t.parentNode.removeChild(t) : t.data = t.data.substr(Oo), this._inlineFiller = null
            }
            _needsInlineFillerAtSelection() {
                ...
                const i = t.nodeBefore,
                    o = t.nodeAfter;
                return !(i instanceof ci || o instanceof ci)
            }
            _updateText(t, e) {
                ...
                if (s && s.parent == t.parent && s.offset == t.index && (r = Ro + r), o != r) {
                    const t = Wo(o, r);
            ...
            _updateChildren(t, e) {
                ...
                let a = 0;
                const c = new Set;
                for (const t of s) "insert" === t ? (Uo(n, a, r[a]), a++) : "delete" === t ? (c.add(o[a]), Ho(o[a])) : (this._markDescendantTextToSync(this.domConverter.domToView(r[a])), a++);
                for (const t of c) t.parentNode || this.domConverter.unbindDomElement(t)
            }
            _diffNodeLists(t, e) {
                return Fo(t, e, function(t, e, n) {
                    if (e === n) return !0;
                    if (Io(e) && Io(n)) return e.data === n.data;
                    if (zo(e, t) && zo(n, t)) return !0;
                    return !1
            ...
            _findReplaceActions(t, e, n) {
                ...
                for (const a of t) "insert" === a ? r.push(n[s.equal + s.insert]) : "delete" === a ? o.push(e[s.equal + s.delete]) : ((i = i.concat(Fo(o, r, Jo).map(t => "equal" === t ? "replace" : t))).push("equal"), o = [], r = []), s[a]++;
                return i.concat(Fo(o, r, Jo).map(t => "equal" === t ? "replace" : t))
            }
            ...
            _updateDomSelection(t) {
                ...
                t.focus(), e.collapse(n.parent, n.offset), e.extend(i.parent, i.offset), co.isGecko && function(t, e) {
                    const n = t.parent;
        ...
        function Qo(t, e, n) {
            const i = e instanceof Array ? e : e.childNodes,
                o = i[n];
            if (Io(o)) return o.data = Ro + o.data, o; {
                const o = t.createTextNode(Ro);
                return Array.isArray(e) ? i.splice(n, 0, o) : Uo(e, n, o), o
            }
        }

        function Jo(t, e) {
            return qo(t) && qo(e) && !Io(t) && !Io(e) && t.tagName.toLowerCase() === e.tagName.toLowerCase()
        }
        F(Go, Li);
        var Ko = {
            window: window,
        ...
        class er {
            constructor(t = {}) {
                this.blockFiller = t.blockFiller || Eo, this.preElements = ["pre"], this.blockElements = ["p", "div", "h1", "h2", "h3", "h4", "h5", "h6"], this._domToViewMapping = new WeakMap, this._viewToDomMapping = new WeakMap, this._fakeSelectionMapping = new WeakMap
            }
            bindFakeSelection(t, e) {
                this._fakeSelectionMapping.set(t, new Ki(e))
            }
            ...
            domRangeToView(t) {
                ...
                return e && n ? new Gi(e, n) : null
            }
            domPositionToView(t, e) {
                if (zo(t, this.blockFiller)) return this.domPositionToView(t.parentNode, Zo(t));
                const n = this.mapDomToView(t);
                if (n && n.is("uiElement")) return $i._createBefore(n);
                if (Io(t)) {
                    if (Lo(t)) return this.domPositionToView(t.parentNode, Zo(t));
                    const n = this.findCorrespondingViewText(t);
                    let i = e;
                    return n ? (Do(t) && (i = (i -= Oo) < 0 ? 0 : i), new $i(n, i)) : null
                }
                if (0 === e) {
                    const e = this.mapDomToView(t);
                    if (e) return new $i(e, 0)
                } else {
                    const n = t.childNodes[e - 1],
                        i = Io(n) ? this.findCorrespondingViewText(n) : this.mapDomToView(n);
                    if (i && i.parent) return new $i(i.parent, i.index + 1)
                }
                return null
            }
            mapDomToView(t) {
            ...
            findCorrespondingViewText(t) {
                ...
                if (n) {
                    ...
                    if (t) {
                        return t.nextSibling instanceof ci ? t.nextSibling : null
                    }
                } else {
                    const e = this.mapDomToView(t.parentNode);
                    if (e) {
                        const t = e.getChild(0);
                        return t instanceof ci ? t : null
                    }
                }
                return null
            }
            ...
            _processDataFromDomText(t) {
                let e = t.data;
                if (nr(t, this.preElements)) return jo(t);
                e = e.replace(/[ \n\t\r]{1,}/g, " ");
                ...
                return o && (e = e.replace(/^ /, "")), r && (e = e.replace(/ $/, "")), e = (e = jo(new Text(e))).replace(/ \u00A0/g, "  "), o && (e = e.replace(/^\u00A0/, " ")), Io(i) && "Â " != i.data.charAt(0) || (e = e.replace(/\u00A0( *)$/, " $1")), e
            }
            ...
            _getTouchingViewTextNode(t, e) {
                const n = new Yi({
                    startPosition: e ? $i._createAfter(t) : $i._createBefore(t),
            ...
            _getTouchingInlineDomNode(t, e) {
                ...
                const n = e ? "nextNode" : "previousNode",
                    ...
                    r = i.createTreeWalker(o, NodeFilter.SHOW_TEXT | NodeFilter.SHOW_ELEMENT, {
                        acceptNode: t => Io(t) ? NodeFilter.FILTER_ACCEPT : "BR" == t.tagName ? NodeFilter.FILTER_ACCEPT : NodeFilter.FILTER_SKIP
                    });
                r.currentNode = t;
                const s = r[n]();
                if (null !== s) {
        ...
        function ir(t, e) {
            for (; t && t != Ko.document;) e(t), t = t.parentNode
        }
            ...
            for (r.set(t, e), r.set(e, t); ++d < a;) {
                ...
                if (h) {
                    if (!mr(e, function(t, e) {
                            if (!pr(h, e) && (f === t || o(f, t, n, i, r))) return h.push(e)
                        })) {
                        u = !1;
                        break
                    }
        ...
        var kr = function(t) {
            ...
            Or = "[object DataView]",
            Rr = o ? o.prototype : void 0,
            Dr = Rr ? Rr.valueOf : void 0;
        var Lr = function(t, e, n, i, o, r, s) {
                switch (n) {
                    case Or:
        ...
        var Wr = function(t, e, n, i, o, r) {
            ...
            if (h && !d) return r || (r = new Gt), s || ke(t) ? wr(t, e, n, i, o, r) : Lr(t, e, c, n, i, o, r);
            if (!(n & Br)) {
                var f = d && qr.call(t, "__wrapped__"),
                    m = u && qr.call(e, "__wrapped__");
                if (f || m) {
                    var p = f ? t.value() : t,
                        g = m ? e.value() : e;
                    return r || (r = new Gt), o(p, g, n, i, r)
                }
            }
            return !!h && (r || (r = new Gt), zr(t, e, n, i, o, r))
        };
        var Yr = function t(e, n, i, o, r) {
            return e === n || (null == e || null == n || !w(e) && !w(n) ? e != e && n != n : Wr(e, n, i, o, t, r))
        };
        var $r = function(t, e, n) {
            var i = (n = "function" == typeof n ? n : void 0) ? n(t, e) : void 0;
            return void 0 === i ? Yr(t, e, void 0, n) : !!i
        };
        class Gr extends cr {
            constructor(t) {
            ...
            _onMutations(t) {
                ...
                for (const n of t)
                    ...
                    if ((!t || !t.is("uiElement")) && "characterData" === o.type) {
                        ...
                        t && !i.has(t.parent) ? n.set(t, {
                            ...
                            newText: jo(o.target),
                            node: t
                        }) : !t && Do(o.target) && i.add(e.mapDomToView(o.target.parentNode))
                    }
                }
                const o = [];
                ...
                for (const t of i) {
                    ...
                    $r(i, r, a) || (this.renderer.markToSync("children", t), o.push({
                        type: "children",
                        oldChildren: i,
                        newChildren: r,
                        node: t
                ...
                if (r && r.anchorNode) {
                    ...
                    t && n && (s = new Ki(t)).setFocus(n)
                }

                function a(t, e) {
                    if (!Array.isArray(t)) return t === e || !(!t.is("text") || !e.is("text")) && t.data === e.data
                }
                this.document.fire("mutations", o, s), this.view.render()
            }
        ...
        class Qr {
            constructor(t, e, n) {
                this.view = t, this.document = t.document, this.domEvent = e, this.domTarget = e.target, Ei(this, n)
            }
            get target() {
        ...
        var as = function(t) {
                ...
                t = t.replace(ns, "");
                var n = os.test(t);
                return n || rs.test(t) ? ss(t.slice(2), n ? 2 : 8) : is.test(t) ? es : +t
            },
            cs = "Expected a function",
            ls = Math.max,
            ds = Math.min;
        var us = function(t, e, n) {
            ...
            return e = as(e) || 0, it(n) && (d = !!n.leading, r = (u = "maxWait" in n) ? ls(as(n.maxWait) || 0, e) : r, h = "trailing" in n ? !!n.trailing : h), b.cancel = function() {
        ...
        class hs extends cr {
            ...
            observe() {
                ...
                t.on("keydown", (e, n) => {
                    t.selection.isFake && function(t) {
                        return t == ho.arrowright || t == ho.arrowleft || t == ho.arrowup || t == ho.arrowdown
            ...
            _handleSelectionMove(t) {
                const e = this.document.selection,
                    n = new Ki(e.getRanges(), {
                        backward: e.isBackward,
                        fake: !1
                    });
                t != ho.arrowleft && t != ho.arrowup || n.setTo(n.getFirstPosition()), t != ho.arrowright && t != ho.arrowdown || n.setTo(n.getLastPosition());
                const i = {
                    oldSelection: e,
                    newSelection: n,
                    domSelection: null
        ...
        class ms extends cr {
            ...
            _handleSelectionChange(t) {
                ...
                if (!this.selection.isEqual(n) || !this.domConverter.isDomSelectionCorrect(e))
                    if (++this._loopbackCounter > 60) fs.a.warn("selectionchange-infinite-loop: Selection change observer detected an infinite rendering loop.");
        ...
        class ps extends Jr {
            constructor(t) {
                ...
                e.on("focus", () => {
                    ...
                    null !== o && o !== i.target || (e.isFocused = !1, t.render())
                })
            }
            onDomEvent(t) {
                this.fire(t.type, t)
        ...
        class ks {
            constructor(t) {
                ...
                if (Object.defineProperty(this, "_source", {
                    ...
                    n.ownerDocument && n.ownerDocument.body.contains(n) || fs.a.warn("rect-source-not-in-dom: The source of this rect does not belong to any rendered DOM tree.", {
                        source: t
                    }), vs(this, e ? ks.getDomRangeRects(t)[0] : t.getBoundingClientRect())
                } else if (or(t)) {
                    const {
                        innerWidth: e,
                        innerHeight: n
            ...
            excludeScrollbarsAndBorders() {
                const t = this._source;
                let e, n;
                if (or(t)) e = t.innerWidth - t.document.documentElement.clientWidth, n = t.innerHeight - t.document.documentElement.clientHeight;
                else {
                    const i = ws(this._source);
            ...
            static getDomRangeRects(t) {
                ...
                if (n.length)
                    for (const t of n) e.push(new ks(t));
                else {
                    let n = t.startContainer;
                    Io(n) && (n = n.parentNode);
                    const i = new ks(n.getBoundingClientRect());
        ...
        function As(t, e, n) {
            const i = e.clone().moveBy(0, n),
                ...
                r = new ks(t).excludeScrollbarsAndBorders();
            if (![o, i].every(t => r.contains(t))) {
                let {
                    scrollX: s,
                    scrollY: a
                } = t;
                Ps(o, r) ? a -= r.top - e.top + n : Ts(i, r) && (a += e.bottom - r.bottom + n), Ms(e, r) ? s -= r.left - e.left + n : Ss(e, r) && (s += e.right - r.right + n), t.scrollTo(s, a)
            }
        }
        ...
        function Cs(t, e) {
            const n = Is(t);
            let i, o;
            for (; t != n.document.body;) o = e(), (i = new ks(t).excludeScrollbarsAndBorders()).contains(o) || (Ps(o, i) ? t.scrollTop -= i.top - o.top : Ts(o, i) && (t.scrollTop += o.bottom - i.bottom), Ms(o, i) ? t.scrollLeft -= i.left - o.left : Ss(o, i) && (t.scrollLeft += o.right - i.right)), t = t.parentNode
        }
            ...
            if (n === e) return i; {
                ...
                for (; t != e;) {
                    const e = t.frameElement,
                        n = new ks(e).excludeScrollbarsAndBorders();
        ...
        class Os {
            ...
            change(t) {
                if (this._renderingInProgress || this._postFixersInProgress) throw new P.b("cannot-change-view-tree: Attempting to make changes to the view when it is in an incorrect state: rendering or post-fixers are in progress. This may cause some unexpected behavior and inconsistency between the DOM and the view.");
                if (this._ongoingChange) return t(this._writer);
                this._ongoingChange = !0;
                const e = t(this._writer);
                return this._ongoingChange = !1, this._renderingDisabled || (this._postFixersInProgress = !0, this.document._callPostFixers(this._writer), this._postFixersInProgress = !1, this.fire("render")), e
            }
            render() {
                this.change(() => {})
            }
        ...
        class Ds {
            ...
            get index() {
                let t;
                if (!this.parent) return null;
                if (null === (t = this.parent.getChildIndex(this))) throw new P.b("model-node-not-found-in-parent: The node's parent does not contain this node.");
                return t
            }
            get startOffset() {
                let t;
                if (!this.parent) return null;
                if (null === (t = this.parent.getChildStartOffset(this))) throw new P.b("model-node-not-found-in-parent: The node's parent does not contain this node.");
                return t
            }
            get offsetSize() {
                return 1
        ...
        class js {
            constructor(t, e, n) {
                if (this.textNode = t, e < 0 || e > t.offsetSize) throw new P.b("model-textproxy-wrong-offsetintext: Given offsetInText value is incorrect.");
                if (n < 0 || e + n > t.offsetSize) throw new P.b("model-textproxy-wrong-length: Given length value is incorrect.");
                this.data = t.data.substring(e, e + n), this.offsetInText = e
            }
            get startOffset() {
        ...
        class Vs {
            ...
            indexToOffset(t) {
                ...
                if (!e) throw new P.b("model-nodelist-index-out-of-bounds: Given index cannot be found in the node list.");
            ...
            offsetToIndex(t) {
                ...
                if (e != t) throw new P.b("model-nodelist-offset-out-of-bounds: Given offset cannot be found in the node list.", {
                    offset: t,
                    nodeList: this
                });
                return this.length
            ...
            _insertNodes(t, e) {
                for (const t of e)
                    if (!(t instanceof Ds)) throw new P.b("model-nodelist-insertNodes-not-node: Trying to insert an object which is not a Node instance.");
        ...
        class zs extends Ds {
            ...
            _clone(t = !1) {
                ...
                return new zs(this.name, this.getAttributes(), e)
            }
            _appendChild(t) {
            ...
            static fromJSON(t) {
                ...
                if (t.children) {
                    e = [];
                    for (const n of t.children) n.name ? e.push(zs.fromJSON(n)) : e.push(Ls.fromJSON(n))
                }
                return new zs(t.name, t.attributes, e)
            }
        }
        class Bs {
            constructor(t = {}) {
                if (!t.boundaries && !t.startPosition) throw new P.b("model-tree-walker-no-start-position: Neither boundaries nor starting position have been defined.");
                const e = t.direction || "forward";
                if ("forward" != e && "backward" != e) throw new P.b("model-tree-walker-unknown-direction: Only `backward` and `forward` direction allowed.", {
                    direction: e
                });
            ...
            _next() {
                ...
                if (i instanceof zs) return this.shallow ? e.offset++ : (e.path.push(0), this._visitedParent = i), this.position = e, Fs("elementStart", i, t, e, 1);
                if (i instanceof Ls) {
                    let o;
                    ...
                    const r = e.offset - i.startOffset,
                        s = new js(i, r, o);
                    return e.offset += o, this.position = e, Fs("text", s, t, e, o)
                }
                return e.path.pop(), e.offset++, this.position = e, this._visitedParent = n.parent, this.ignoreElementEnd ? this._next() : Fs("elementEnd", n, t, e)
            }
            _previous() {
                const t = this.position,
                    e = this.position.clone(),
                ...
                if (i instanceof zs) return e.offset--, this.shallow ? (this.position = e, Fs("elementStart", i, t, e, 1)) : (e.path.push(i.maxOffset), this.position = e, this._visitedParent = i, this.ignoreElementEnd ? this._previous() : Fs("elementEnd", i, t, e));
                if (i instanceof Ls) {
                    let o;
                    if (this.singleCharacters) o = 1;
                    else {
                ...
                return e.path.pop(), this.position = e, this._visitedParent = n.parent, Fs("elementStart", n, t, e, 1)
            }
        }
        ...
        class Hs {
            constructor(t, e, n = "toNone") {
                if (!t.is("element") && !t.is("documentFragment")) throw new P.b("model-position-root-invalid: Position root invalid.");
                if (!(e instanceof Array) || 0 === e.length) throw new P.b("model-position-path-incorrect: Position path must be an array with at least one item.", {
                    path: e
                });
            ...
            isTouching(t) {
                ...
                switch (this.compareWith(t)) {
                    case "same":
                        return !0;
                    case "before":
                        e = Hs._createAt(this), n = Hs._createAt(t);
                        break;
                    case "after":
                        e = Hs._createAt(t), n = Hs._createAt(this);
                        break;
                    default:
                        return !1
                }
            ...
            _getTransformedByMergeOperation(t) {
                const e = t.movedRange;
                let n;
                return e.containsPosition(this) || e.start.isEqual(this) ? (n = this._getCombined(t.sourcePosition, t.targetPosition), t.sourcePosition.isBefore(t.targetPosition) && (n = n._getTransformedByDeletion(t.deletionPosition, 1))) : n = this.isEqual(t.deletionPosition) ? Hs._createAt(t.deletionPosition) : this._getTransformedByMove(t.deletionPosition, t.graveyardPosition, 1), n
            }
            _getTransformedByDeletion(t, e) {
                const n = Hs._createAt(this);
            ...
            _getTransformedByInsertion(t, e) {
                const n = Hs._createAt(this);
                if (this.root != t.root) return n;
                if ("same" == U(t.getParentPath(), this.getParentPath()))(t.offset < this.offset || t.offset == this.offset && "toPrevious" != this.stickiness) && (n.offset += e);
                else if ("prefix" == U(t.getParentPath(), this.getParentPath())) {
                    const i = t.path.length - 1;
            ...
            _getTransformedByMove(t, e, n) {
                if (e = e._getTransformedByDeletion(t, n), t.isEqual(e)) return Hs._createAt(this);
            ...
            static _createAt(t, e) {
                if (t instanceof Hs) return new Hs(t.root, t.path, t.stickiness); {
                    const n = t;
                    if ("end" == e) e = n.maxOffset;
                    else {
                        if ("before" == e) return this._createBefore(n);
                        if ("after" == e) return this._createAfter(n);
                        if (0 !== e && !e) throw new P.b("model-createPositionAt-offset-required: Model#createPositionAt() requires the offset when the first parameter is a model item.")
                    }
                    if (!n.is("element") && !n.is("documentFragment")) throw new P.b("model-position-parent-incorrect: Position parent have to be a element or document fragment.");
                    const i = n.getPath();
                    return i.push(e), new this(n.root, i)
                }
            }
            static _createAfter(t) {
                if (!t.parent) throw new P.b("model-position-after-root: You cannot make a position after root.", {
                    root: t
                });
                return this._createAt(t.parent, t.endOffset)
            }
            static _createBefore(t) {
                if (!t.parent) throw new P.b("model-position-before-root: You cannot make a position before root.", {
                    root: t
                });
            ...
            static fromJSON(t, e) {
                ...
                if (!e.getRoot(t.root)) throw new P.b("model-position-fromjson-no-root: Cannot create position for document. Root with specified name does not exist.", {
                    rootName: t.root
                });
        ...
        class qs {
            constructor(t, e = null) {
                this.start = Hs._createAt(t), this.end = e ? Hs._createAt(e) : Hs._createAt(t), this.start.stickiness = this.isCollapsed ? "toNone" : "toNext", this.end.stickiness = this.isCollapsed ? "toNone" : "toPrevious"
            }*[Symbol.iterator]() {
                yield* new Bs({
                    boundaries: this,
                    ignoreElementEnd: !0
            ...
            getTransformedByOperations(t) {
                const e = [new qs(this.start, this.end)];
                for (const n of t)
            ...
            _getTransformedByMergeOperation(t) {
                ...
                return e.root != n.root && (n = this.end.getShiftedBy(-1)), e.isAfter(n) ? (t.sourcePosition.isBefore(t.targetPosition) ? (e = Hs._createAt(n)).offset = 0 : (t.deletionPosition.isEqual(e) || (n = t.deletionPosition), e = t.targetPosition), new qs(e, n)) : new qs(e, n)
            }
            ...
            _getTransformedByMove(t, e, n, i = !1) {
                ...
                const o = qs._createFromPositionAndShift(t, n),
            ...
            static _createIn(t) {
                return new this(Hs._createAt(t, 0), Hs._createAt(t, t.maxOffset))
            }
            static _createOn(t) {
                return this._createFromPositionAndShift(Hs._createBefore(t), t.offsetSize)
            }
            static _createFromRanges(t) {
                if (0 === t.length) throw new P.b("range-create-from-ranges-empty-array: At least one range has to be passed.");
                ...
                if (n > 0)
                    for (let e = n - 1; t[e].end.isEqual(i.start); e++) i.start = Hs._createAt(t[e].start);
                for (let e = n + 1; e < t.length && t[e].start.isEqual(i.end); e++) i.end = Hs._createAt(t[e].end);
                return i
            }
            static fromJSON(t, e) {
        ...
        class Ws {
            constructor() {
                this._modelToViewMapping = new WeakMap, this._viewToModelMapping = new WeakMap, this._viewToModelLengthCallbacks = new Map, this._markerNameToElements = new Map, this.on("modelToViewPosition", (t, e) => {
                    ...
                    for (; !i;) n = n.parent, i = this._viewToModelMapping.get(n);
                    const o = this._toModelOffset(e.viewPosition.parent, e.viewPosition.offset, n);
                    e.modelPosition = Hs._createAt(i, o)
                }, {
                    priority: "low"
                })
            }
            ...
            toViewRange(t) {
                return new Gi(this.toViewPosition(t.start), this.toViewPosition(t.end))
            }
            toModelPosition(t) {
                const e = {
                    viewPosition: t,
            ...
            _findPositionIn(t, e) {
                let n, i = 0,
                    o = 0,
                    r = 0;
                if (t.is("text")) return new $i(t, e);
                for (; o < e;) n = t.getChild(r), o += i = this.getModelLength(n), r++;
                return o == e ? this._moveViewPositionToTextNode(new $i(t, r)) : this._findPositionIn(n, e - (o - i))
            }
            _moveViewPositionToTextNode(t) {
                const e = t.nodeBefore,
                    n = t.nodeAfter;
                return e instanceof ci ? new $i(e, e.data.length) : n instanceof ci ? new $i(n, 0) : t
            }
        }
        F(Ws, R);
        class Ys {
            ...
            add(t, e) {
                e = $s(e), t instanceof js && (t = this._getSymbolForTextProxy(t)), this._consumable.has(t) || this._consumable.set(t, new Map), this._consumable.get(t).set(e, !0)
            }
            consume(t, e) {
                return e = $s(e), t instanceof js && (t = this._getSymbolForTextProxy(t)), !!this.test(t, e) && (this._consumable.get(t).set(e, !1), !0)
            }
            test(t, e) {
                e = $s(e), t instanceof js && (t = this._getSymbolForTextProxy(t));
        ...
        class Gs {
            constructor(t = {}) {
                this.conversionApi = Ei({
                    dispatcher: this
                }, t)
            }
            convertChanges(t, e) {
                for (const n of t.getMarkersToRemove()) this.convertMarkerRemove(n.name, n.range, e);
                for (const n of t.getChanges()) "insert" == n.type ? this.convertInsert(qs._createFromPositionAndShift(n.position, n.length), e) : "remove" == n.type ? this.convertRemove(n.position, n.length, n.name, e) : this.convertAttribute(n.range, n.attributeKey, n.attributeOldValue, n.attributeNewValue, e);
            ...
            convertInsert(t, e) {
                ...
                for (const e of t) {
                    const t = e.item,
                        n = {
                            item: t,
                            range: qs._createFromPositionAndShift(e.previousPosition, e.length)
                        };
            ...
            convertAttribute(t, e, n, i, o) {
                ...
                for (const o of t) {
                    const t = {
                        item: o.item,
                        range: qs._createFromPositionAndShift(o.previousPosition, o.length),
                        attributeKey: e,
                        attributeOldValue: n,
                        attributeNewValue: i
                    };
            ...
            convertMarkerAdd(t, e, n) {
                ...
                if (e.isCollapsed) {
                    const n = new Ys;
                    return n.add(e, i), this.conversionApi.consumable = n, void this.fire(i, {
                        markerName: t,
                        markerRange: e
                    }, this.conversionApi)
                }
        ...
        class Js {
            ...
            isEqual(t) {
                ...
                for (const t of this._ranges) yield new qs(t.start, t.end)
            }
            getFirstRange() {
                let t = null;
                for (const e of this._ranges) t && !e.start.isBefore(t.start) || (t = e);
            ...
            setTo(t, e, n) {
                ...
                else if (t instanceof Js) this._setRanges(t.getRanges(), t.isBackward);
                else if (t && "function" == typeof t.getRanges) this._setRanges(t.getRanges(), t.isBackward);
                else if (t instanceof qs) this._setRanges([t], !!e && !!e.backward);
                else if (t instanceof Hs) this._setRanges([new qs(t)]);
                else if (t instanceof Ds) {
                    const i = !!n && !!n.backward;
                    let o;
                    if ("in" == e) o = qs._createIn(t);
                    else if ("on" == e) o = qs._createOn(t);
                    else {
                        if (void 0 === e) throw new P.b("model-selection-setTo-required-second-parameter: selection.setTo requires the second parameter when the first parameter is a node.");
                        o = new qs(Hs._createAt(t, e))
                    }
                    this._setRanges([o], i)
                } else {
                    if (!ui(t)) throw new P.b("model-selection-setTo-not-selectable: Cannot set selection to given place.");
                    this._setRanges(t, e && !!e.backward)
                }
            }
            _setRanges(t, e = !1) {
                const n = (t = Array.from(t)).some(t => {
                    if (!(t instanceof qs)) throw new P.b("model-selection-set-ranges-not-range: Selection range set to an object that is not an instance of model.Range.");
            ...
            setFocus(t, e) {
                if (null === this.anchor) throw new P.b("model-selection-setFocus-no-ranges: Cannot set selection focus if there are no ranges in selection.");
                const n = Hs._createAt(t, e);
                if ("same" == n.compareWith(this.focus)) return;
                const i = this.anchor;
            ...
            getSelectedElement() {
                ...
                const t = this.getFirstRange(),
                    e = t.start.nodeAfter,
                    n = t.end.nodeBefore;
                return e instanceof zs && e == n ? e : null
            }* getSelectedBlocks() {
                const t = new WeakSet;
                for (const e of this.getRanges()) {
                    ...
                    const i = Zs(e.end, t);
                    i && !e.end.isTouching(Hs._createAt(i, 0)) && (yield i)
                }
            }
            containsEntireContent(t = this.anchor.root) {
                const e = Hs._createAt(t, 0),
                    n = Hs._createAt(t, "end");
            ...
            _checkRange(t) {
                for (let e = 0; e < this._ranges.length; e++)
                    if (t.isIntersecting(this._ranges[e])) throw new P.b("model-selection-range-intersects: Trying to add a range that intersects with another range in the selection.", {
                        addedRange: t,
        ...
        class na extends Js {
            constructor(t) {
                super(), this._model = t.model, this._document = t, this._attributePriority = new Map, this._fixGraveyardRangesData = [], this._hasChangedRange = !1, this._overriddenGravityRegister = new Set, this.on("change:range", () => {
                    for (const t of this.getRanges())
                        if (!this._document._validateSelectionRange(t)) throw new P.b("document-selection-wrong-position: Range from document selection starts or ends at incorrect position.", {
                            range: t
                        })
            ...
            restoreGravity(t) {
                if (!this._overriddenGravityRegister.has(t)) throw new P.b("document-selection-gravity-wrong-restore: Attempting to restore the selection gravity for an unknown UID.", {
                    uid: t
                });
            ...
            _updateAttributes(t) {
                const e = Rs(this._getSurroundingAttributes()),
                    n = Rs(this.getAttributes());
            ...
            _getSurroundingAttributes() {
                ...
                if (this.isCollapsed) {
                    ...
                    if (this.isGravityOverridden || (n = ia(e)), n || (n = ia(i)), !this.isGravityOverridden && !n) {
                        let t = e;
                        for (; t && !n;) n = ia(t = t.previousSibling)
                    }
                    if (!n) {
                        let t = i;
                        for (; t && !n;) n = ia(t = t.nextSibling)
                    }
                    ...
                    for (const i of t) {
                        ...
                        "text" == i.type && null === n && (n = i.item.getAttributes())
                    }
                }
                return n
            }
        ...
        function ca(t) {
            ...
            if (t.model.name && (e += ":" + t.model.name), t.model.values)
                for (const e of t.model.values) t.view[e] = da(t.view[e], "attribute");
            else t.view = da(t.view, "attribute");
            const n = ua(t);
            return i => {
                i.on(e, function(t) {
                    return (e, n, i) => {
                        ...
                        if (n.item instanceof Js || n.item instanceof ea) s.wrap(a.getFirstRange(), r);
                        else {
        ...
        function la(t) {
            let e = "attribute:" + ((t = sa(t)).model.key ? t.model.key : t.model);
            if (t.model.name && (e += ":" + t.model.name), t.model.values)
                for (const e of t.model.values) t.view[e] = ha(t.view[e]);
            else t.view = ha(t.view);
            const n = ua(t);
            return i => {
                i.on(e, function(t) {
                    return t = t || ((t, e) => ({
                        ...
                        } else fs.a.warn("conversion-attribute-to-attribute-on-text: Trying to convert text node's attribute with attribute-to-attribute converter.")
                    }
                }(n), {
                    priority: t.converterPriority || "normal"
                })
        ...
        function da(t, e) {
            return "function" == typeof t ? t : (n, i) => (function(t, e, n) {
                ...
                if ("container" == n) i = e.createContainerElement(t.name, o);
                    ...
                    const n = {
                        priority: t.priority || no.DEFAULT_PRIORITY
                    };
        ...
        class fa {
            constructor(t) {
                this.model = t, this.view = new Os, this.mapper = new Ws, this.downcastDispatcher = new Gs({
                    mapper: this.mapper
                });
        ...
        class ma {
            ...
            load(t, e = []) {
                ...
                function l(t) {
                    if (!a.includes(t) && !n.get(t) && !o.has(t)) return function(t) {
                        return new Promise(s => {
                            o.add(t), t.requires && t.requires.forEach(n => {
                                const i = d(n);
                                if (e.includes(i)) throw new P.b("plugincollection-required: Cannot load a plugin because one of its dependencies is listed inthe `removePlugins` option.", {
                                    plugin: i,
                                    requiredBy: t
                                });
                                l(i)
                        ...
                        throw fs.a.error("plugincollection-load: It was not possible to load the plugin.", {
                            plugin: t
                        }), e
                    })
                }
        ...
        class pa {
            ...
            execute(t, ...e) {
                const n = this.get(t);
                if (!n) throw new P.b("commandcollection-command-not-found: Command does not exist.", {
                    commandName: t
                });
                n.execute(...e)
            }* names() {
        ...
        class _a {
            ...
            _add(t, e) {
                ...
                for (const e of n) {
                    if ("attributes" === t && ("class" === e || "style" === e)) throw new P.b("viewconsumable-invalid-attribute: Classes and styles should be handled separately.");
                    i.set(e, !0)
                }
            }
            _test(t, e) {
        ...
        class ka {
            ...
            register(t, e) {
                if (this._sourceDefinitions[t]) throw new P.b("schema-cannot-register-item-twice: A single item cannot be registered twice in the schema.", {
                    itemName: t
                });
                this._sourceDefinitions[t] = [Object.assign({}, e)], this._clearCache()
            }
            extend(t, e) {
                if (!this._sourceDefinitions[t]) throw new P.b("schema-cannot-extend-missing-item: Cannot extend an item which was not registered yet.", {
                    itemName: t
                });
            ...
            checkMerge(t, e = null) {
                if (t instanceof Hs) {
                    const e = t.nodeBefore,
                        n = t.nodeAfter;
                    if (!(e instanceof zs)) throw new P.b("schema-check-merge-no-element-before: The node before the merge position must be an element.");
                    if (!(n instanceof zs)) throw new P.b("schema-check-merge-no-element-after: The node after the merge position must be an element.");
            ...
            checkAttributeInSelection(t, e) {
                ...
                for (const o of t.getItems({
                        shallow: !0
                    })) o.is("element") && (yield* this._getValidRangesForRange(qs._createIn(o), e)), this.checkAttribute(o, e) || (n.isEqual(i) || (yield new qs(n, i)), n = Hs._createAfter(o)), i = Hs._createAfter(o);
                n.isEqual(i) || (yield new qs(n, i))
            }
            getNearestSelectionRange(t, e = "both") {
                ...
                for (const t of function*(t, e) {
                    ...
                    const e = t.walker == n ? "elementEnd" : "elementStart",
                        i = t.value;
                    if (i.type == e && this.isObject(i.item)) return qs._createOn(i.item);
                    if (this.checkChild(i.nextPosition, "$text")) return new qs(i.nextPosition)
                }
                return null
            }
        ...
        class va {
            constructor(t) {
                ...
                "string" == typeof t ? t = [t] : Array.isArray(t) || (t = t.getAncestors({
                    includeSelf: !0
                })), t[0] && "string" != typeof t[0] && t[0].is("documentFragment") && t.shift(), this._items = t.map(Ea)
            }
            get length() {
                return this._items.length
            }
        ...
        function ya(t, e) {
            ...
            return function(t, e) {
                ...
                }(t, n), Sa(t, n, "allowIn"), Sa(t, n, "allowContentOf"), Sa(t, n, "allowWhere"), Sa(t, n, "allowAttributes"), Sa(t, n, "allowAttributesOf"), Sa(t, n, "inheritTypesFrom"),
                function(t, e) {
                    for (const n of t) {
        ...
        class Na {
            ...
            _convertItem(t, e) {
                ...
                if (t.is("element") ? this.fire("element:" + t.name, n, this.conversionApi) : t.is("text") ? this.fire("text", n, this.conversionApi) : this.fire("documentFragment", n, this.conversionApi), n.modelRange && !(n.modelRange instanceof qs)) throw new P.b("view-conversion-dispatcher-incorrect-result: Incorrect conversion result was dropped.");
                return {
        ...
        function Oa(t) {
            const e = function(t) {
                    ...
                    return (n, i, o) => {
                        ...
                        o.consumable.consume(i.viewItem, r.match), i.modelRange = new qs(o.writer.createPositionBefore(s), o.writer.createPositionAfter(c.modelCursor.parent)), a.cursorParent ? i.modelCursor = o.writer.createPositionAt(a.cursorParent, 0) : i.modelCursor = i.modelRange.end
                    }
                }(t = sa(t)),
                n = La(t),
        ...
        class za {
            constructor(t, e) {
                this.model = t, this.processor = e, this.mapper = new Ws, this.downcastDispatcher = new Gs({
                    mapper: this.mapper
            ...
            init(t, e = "main") {
                if (this.model.document.version) throw new P.b("datacontroller-init-document-not-empty: Trying to set initial data to not empty document.");
                const n = this.model.document.getRoot(e);
                return this.model.enqueueChange("transparent", e => {
                    e.insert(this.parse(t, n), n, 0)
                }), Promise.resolve()
            }
            set(t, e = "main") {
                const n = this.model.document.getRoot(e);
                this.model.enqueueChange("transparent", e => {
                    e.setSelection(null), e.removeSelectionAttribute(this.model.document.selection.getAttributeKeys()), e.remove(e.createRangeIn(n)), e.insert(this.parse(t, n), n, 0)
                })
            }
            parse(t, e = "$root") {
        ...
        class Ba {
            ...
            register(t, e) {
                if (this._dispatchersGroups.has(t)) throw new P.b("conversion-register-group-exists: Trying to register a group name that was already registered.");
            ...
            elementToElement(t) {
                ...
                for (const {
                        model: e,
                        view: n
                    } of Fa(t)) this.for("upcast").add(Oa({
                    model: e,
                    view: n,
            ...
            attributeToElement(t) {
                ...
                for (const {
                        model: e,
                        view: n
                    } of Fa(t)) this.for("upcast").add(Ra({
                    view: n,
                    model: e,
                    priority: t.priority
                }))
            ...
            attributeToAttribute(t) {
                ...
                for (const {
                        model: e,
                        view: n
                    } of Fa(t)) this.for("upcast").add(Da({
                    view: n,
                    model: e
                }))
            }
            _getDispatchers(t) {
                ...
                if (!e) throw new P.b("conversion-for-unknown-group: Trying to add a converter to an unknown dispatchers group.");
                return e
            }
        }
        ...
        class Wa {
            ...
            static fromJSON(t) {
                const e = [];
                for (const n of t) n.name ? e.push(zs.fromJSON(n)) : e.push(Ls.fromJSON(n));
                return new Wa(e)
            }
            _appendChild(t) {
                this._insertChild(this.childCount, t)
        ...
        function Ya(t, e) {
            const n = (e = Qa(e)).reduce((t, e) => t + e.offsetSize, 0),
                i = t.parent;
            Ka(t);
            const o = t.index;
            return i._insertChild(o, e), Ja(i, o + e.length), Ja(i, o), new qs(t, t.getShiftedBy(n))
        }

        function $a(t) {
            if (!t.isFlat) throw new P.b("operation-utils-remove-range-not-flat: Trying to remove a range which starts and ends in different element.");
            const e = t.start.parent;
            Ka(t.start), Ka(t.end);
        ...
        function Ga(t, e) {
            if (!t.isFlat) throw new P.b("operation-utils-move-range-not-flat: Trying to move a range which starts and ends in different element.");
            const n = $a(t);
        ...
        function Qa(t) {
            ...
            for (let n = 0; n < t.length; n++)
                if ("string" == typeof t[n]) e.push(new Ls(t[n]));
                else if (t[n] instanceof js) e.push(new Ls(t[n].data, t[n].getAttributes()));
            else if (t[n] instanceof Wa || t[n] instanceof Vs)
                for (const i of t[n]) e.push(i);
            else t[n] instanceof Ds && e.push(t[n]);
            for (let t = 1; t < e.length; t++) {
                const n = e[t],
                    i = e[t - 1];
                n instanceof Ls && i instanceof Ls && Za(n, i) && (e.splice(t - 1, 2, new Ls(i.data + n.data, i.getAttributes())), t--)
            }
            return e
        }
        ...
        function Ja(t, e) {
            const n = t.getChild(e - 1),
                i = t.getChild(e);
            if (n && i && n.is("text") && i.is("text") && Za(n, i)) {
                const o = new Ls(n.data + i.data, n.getAttributes());
        ...
        function Ka(t) {
            ...
            if (e) {
                ...
                const r = new Ls(e.data.substr(0, i), e.getAttributes()),
        ...
        class tc extends qa {
            ...
            _validate() {
                if (!this.range.isFlat) throw new P.b("attribute-operation-range-not-flat: The range to change is not flat.");
                for (const t of this.range.getItems({
                        shallow: !0
                    })) {
                    if (null !== this.oldValue && !Xa(t.getAttribute(this.key), this.oldValue)) throw new P.b("attribute-operation-wrong-old-value: Changed node has different attribute value than operation's old attribute value.", {
                        item: t,
                        key: this.key,
                        value: this.oldValue
                    });
                    if (null === this.oldValue && null !== this.newValue && t.hasAttribute(this.key)) throw new P.b("attribute-operation-attribute-exists: The attribute with given key already exists.", {
                        node: t,
                        key: this.key
                    })
                }
        ...
        class ec extends qa {
            ...
            _validate() {
                if (this.sourcePosition.root.document) throw new P.b("detach-operation-on-document-node: Cannot detach document node.")
            }
            _execute() {
                $a(qs._createFromPositionAndShift(this.sourcePosition, this.howMany))
            }
            static get className() {
        ...
        class nc extends qa {
            ...
            _validate() {
                ...
                if (!t || !e) throw new P.b("move-operation-position-invalid: Source position or target position is invalid.");
                if (n + this.howMany > t.maxOffset) throw new P.b("move-operation-nodes-do-not-exist: The nodes which should be moved do not exist.");
                if (t === e && n < i && i < n + this.howMany) throw new P.b("move-operation-range-into-itself: Trying to move a range of nodes to the inside of that range.");
                if (this.sourcePosition.root == this.targetPosition.root && "prefix" == U(this.sourcePosition.getParentPath(), this.targetPosition.getParentPath())) {
                    ...
                    if (this.targetPosition.path[t] >= n && this.targetPosition.path[t] < n + this.howMany) throw new P.b("move-operation-node-into-itself: Trying to move a range of nodes into one of nodes from that range.")
                }
            }
            _execute() {
                Ga(qs._createFromPositionAndShift(this.sourcePosition, this.howMany), this.targetPosition)
            }
            toJSON() {
                const t = super.toJSON();
            ...
            static fromJSON(t, e) {
                const n = Hs.fromJSON(t.sourcePosition, e),
                    i = Hs.fromJSON(t.targetPosition, e);
                return new this(n, t.howMany, i, t.baseVersion)
            }
        }
        class ic extends qa {
            constructor(t, e, n) {
                super(n), this.position = t.clone(), this.position.stickiness = "toNone", this.nodes = new Vs(Qa(e)), this.shouldReceiveAttributes = !1
            }
            get type() {
                return "insert"
            }
            ...
            clone() {
                const t = new Vs([...this.nodes].map(t => t._clone(!0))),
                    e = new ic(this.position, t, this.baseVersion);
            ...
            _validate() {
                ...
                if (!t || t.maxOffset < this.position.offset) throw new P.b("insert-operation-position-invalid: Insertion position is invalid.")
            }
            _execute() {
                const t = this.nodes;
            ...
            static fromJSON(t, e) {
                const n = [];
                for (const e of t.nodes) e.name ? n.push(zs.fromJSON(e)) : n.push(Ls.fromJSON(e));
                const i = new ic(Hs.fromJSON(t.position, e), n, t.baseVersion);
        ...
        class oc extends qa {
            ...
            clone() {
                return new oc(this.name, this.oldRange, this.newRange, this._markers, this.affectsData, this.baseVersion)
            }
            getReversed() {
                return new oc(this.name, this.newRange, this.oldRange, this._markers, this.affectsData, this.baseVersion + 1)
            }
            _execute() {
            ...
            static fromJSON(t, e) {
                return new oc(t.name, t.oldRange ? qs.fromJSON(t.oldRange, e) : null, t.newRange ? qs.fromJSON(t.newRange, e) : null, e.model.markers, t.affectsData, t.baseVersion)
            }
        }
        class rc extends qa {
            constructor(t, e, n, i) {
            ...
            clone() {
                return new rc(this.position.clone(), this.oldName, this.newName, this.baseVersion)
            }
            getReversed() {
                return new rc(this.position.clone(), this.newName, this.oldName, this.baseVersion + 1)
            }
            _validate() {
                const t = this.position.nodeAfter;
                if (!(t instanceof zs)) throw new P.b("rename-operation-wrong-position: Given position is invalid or node after it is not an instance of Element.");
                if (t.name !== this.oldName) throw new P.b("rename-operation-wrong-name: Element to change has different name than operation's old name.")
            }
            _execute() {
        ...
        class sc extends qa {
            ...
            _validate() {
                if (this.root != this.root.root || this.root.is("documentFragment")) throw new P.b("rootattribute-operation-not-a-root: The element to change is not a root element.", {
                    root: this.root,
                    key: this.key
                });
                if (null !== this.oldValue && this.root.getAttribute(this.key) !== this.oldValue) throw new P.b("rootattribute-operation-wrong-old-value: Changed node has different attribute value than operation's old attribute value.", {
                    root: this.root,
                    key: this.key
                });
                if (null === this.oldValue && null !== this.newValue && this.root.hasAttribute(this.key)) throw new P.b("rootattribute-operation-attribute-exists: The attribute with given key already exists.", {
                    root: this.root,
                    key: this.key
                })
            }
            ...
            static fromJSON(t, e) {
                if (!e.getRoot(t.root)) throw new P.b("rootattribute-operation-fromjson-no-root: Cannot create RootAttributeOperation. Root with specified name does not exist.", {
                    rootName: t.root
                });
        ...
        class ac extends qa {
            ...
            getReversed() {
                const t = this.targetPosition._getTransformedByMergeOperation(this),
                    ...
                    n = new Hs(this.sourcePosition.root, e)._getTransformedByMergeOperation(this),
                    i = new cc(t, this.howMany, this.graveyardPosition, this.baseVersion + 1);
                return i.insertionPosition = n, i
            }
            _validate() {
                const t = this.sourcePosition.parent,
                    e = this.targetPosition.parent;
                if (!(t && t.is("element") && t.parent)) throw new P.b("merge-operation-source-position-invalid: Merge source position is invalid.");
                if (!(e && e.is("element") && e.parent)) throw new P.b("merge-operation-target-position-invalid: Merge target position is invalid.");
                if (this.howMany != t.maxOffset) throw new P.b("merge-operation-how-many-invalid: Merge operation specifies wrong number of nodes to move.")
            }
            _execute() {
                const t = this.sourcePosition.parent;
                Ga(qs._createIn(t), this.targetPosition), Ga(qs._createOn(t), this.graveyardPosition)
            }
            toJSON() {
                const t = super.toJSON();
            ...
            static fromJSON(t, e) {
                const n = Hs.fromJSON(t.sourcePosition, e),
                    i = Hs.fromJSON(t.targetPosition, e),
                    o = Hs.fromJSON(t.graveyardPosition, e);
                return new this(n, t.howMany, i, o, t.baseVersion)
            }
        }
        class cc extends qa {
            constructor(t, e, n, i) {
                super(i), this.splitPosition = t.clone(), this.splitPosition.stickiness = "toNext", this.howMany = e, this.insertionPosition = cc.getInsertionPosition(t), this.insertionPosition.stickiness = "toNone", this.graveyardPosition = n ? n.clone() : null, this.graveyardPosition && (this.graveyardPosition.stickiness = "toNext")
            }
            get type() {
                return "split"
            }
            ...
            _validate() {
                ...
                if (!t || t.maxOffset < e) throw new P.b("split-operation-position-invalid: Split position is invalid.");
                if (!t.parent) throw new P.b("split-operation-split-in-root: Cannot split root element.");
                if (this.howMany != t.maxOffset - this.splitPosition.offset) throw new P.b("split-operation-how-many-invalid: Split operation specifies wrong number of nodes to move.");
                if (this.graveyardPosition && !this.graveyardPosition.nodeAfter) throw new P.b("split-operation-graveyard-position-invalid: Graveyard position invalid.")
            }
            _execute() {
                const t = this.splitPosition.parent;
                if (this.graveyardPosition) Ga(qs._createFromPositionAndShift(this.graveyardPosition, 1), this.insertionPosition);
                else {
                    const e = t._clone();
                    Ya(this.insertionPosition, e)
                }
                Ga(new qs(Hs._createAt(t, this.splitPosition.offset), Hs._createAt(t, t.maxOffset)), this.moveTargetPosition)
            }
            toJSON() {
                const t = super.toJSON();
            ...
            static fromJSON(t, e) {
                const n = Hs.fromJSON(t.splitPosition, e),
                    i = Hs.fromJSON(t.insertionPosition, e),
                    o = t.graveyardPosition ? Hs.fromJSON(t.graveyardPosition, e) : null,
        ...
        class dc {
            ...
            insert(t, e, n = 0) {
                ...
                const i = Hs._createAt(e, n);
                if (t.parent) {
                    if (pc(t.root, i.root)) return void this.move(qs._createOn(t), i);
                ...
                const o = i.root.document ? i.root.document.version : null,
                    r = new ic(i, t, o);
                if (t instanceof Ls && (r.shouldReceiveAttributes = !0), this.batch.addOperation(r), this.model.applyOperation(r), t instanceof Wa)
                    for (const [e, n] of t.markers) {
                        const t = Hs._createAt(n.root, 0),
                            o = new qs(n.start._getCombined(t, i), n.end._getCombined(t, i));
                        this.addMarker(e, {
                            range: o,
                            usingOperation: !0,
                            affectsData: !0
            ...
            insertText(t, e, n, i) {
                e instanceof Wa || e instanceof zs || e instanceof Hs ? this.insert(this.createText(t), e, n) : this.insert(this.createText(t, e), n, i)
            }
            insertElement(t, e, n, i) {
                e instanceof Wa || e instanceof zs || e instanceof Hs ? this.insert(this.createElement(t), e, n) : this.insert(this.createElement(t, e), n, i)
            }
            append(t, e) {
                this.insert(t, e, "end")
            }
            appendText(t, e, n) {
                e instanceof Wa || e instanceof zs ? this.insert(this.createText(t), e, "end") : this.insert(this.createText(t, e), n, "end")
            }
            appendElement(t, e, n) {
                e instanceof Wa || e instanceof zs ? this.insert(this.createElement(t), e, "end") : this.insert(this.createElement(t, e), n, "end")
            }
            setAttribute(t, e, n) {
                if (this._assertWriterUsedCorrectly(), n instanceof qs) {
                    const i = n.getMinimalFlatRanges();
                    for (const n of i) uc(this, t, e, n)
                } else hc(this, t, e, n)
            }
            setAttributes(t, e) {
                for (const [n, i] of Rs(t)) this.setAttribute(n, i, e)
            }
            removeAttribute(t, e) {
            ...
            move(t, e, n) {
                if (this._assertWriterUsedCorrectly(), !(t instanceof qs)) throw new P.b("writer-move-invalid-range: Invalid range to move.");
                if (!t.isFlat) throw new P.b("writer-move-range-not-flat: Range to move is not flat.");
                const i = Hs._createAt(e, n);
                if (!pc(t.root, i.root)) throw new P.b("writer-move-different-document: Range is going to be moved between different documents.");
                const o = t.root.document ? t.root.document.version : null,
                    r = new nc(t.start, t.end.offset - t.start.offset, i, o);
            ...
            remove(t) {
                if (this._assertWriterUsedCorrectly(), t instanceof qs) {
                    ...
                    mc(Hs._createBefore(t), e, this.batch, this.model)
                }
            }
            merge(t) {
                this._assertWriterUsedCorrectly();
                const e = t.nodeBefore,
                    n = t.nodeAfter;
                if (!(e instanceof zs)) throw new P.b("writer-merge-no-element-before: Node before merge position must be an element.");
                if (!(n instanceof zs)) throw new P.b("writer-merge-no-element-after: Node after merge position must be an element.");
            ...
            _mergeDetached(t) {
                const e = t.nodeBefore,
                    n = t.nodeAfter;
                this.move(qs._createIn(n), Hs._createAt(e, "end")), this.remove(n)
            }
            _merge(t) {
                const e = Hs._createAt(t.nodeBefore, "end"),
                    n = Hs._createAt(t.nodeAfter, 0),
                    i = t.root.document.graveyard,
                    o = new Hs(i, [0]),
                    r = t.root.document.version,
                    s = new ac(n, t.nodeAfter.maxOffset, e, o, r);
                this.batch.addOperation(s), this.model.applyOperation(s)
            }
            rename(t, e) {
                if (this._assertWriterUsedCorrectly(), !(t instanceof zs)) throw new P.b("writer-rename-not-element-instance: Trying to rename an object which is not an instance of Element.");
                const n = t.root.document ? t.root.document.version : null,
                    i = new rc(Hs._createBefore(t), t.name, e, n);
                this.batch.addOperation(i), this.model.applyOperation(i)
            }
            split(t, e) {
                this._assertWriterUsedCorrectly();
                let n, i, o = t.parent;
                if (!o.parent) throw new P.b("writer-split-element-no-parent: Element with no parent can not be split.");
                if (e || (e = o.parent), !t.parent.getAncestors({
                        includeSelf: !0
                    }).includes(e)) throw new P.b("writer-split-invalid-limit-element: Limit element is not a position ancestor.");
                do {
                ...
                return {
                    position: t,
                    range: new qs(Hs._createAt(n, "end"), Hs._createAt(i, 0))
                }
            }
            wrap(t, e) {
                if (this._assertWriterUsedCorrectly(), !t.isFlat) throw new P.b("writer-wrap-range-not-flat: Range to wrap is not flat.");
                const n = e instanceof zs ? e : new zs(e);
                if (n.childCount > 0) throw new P.b("writer-wrap-element-not-empty: Element to wrap with is not empty.");
                if (null !== n.parent) throw new P.b("writer-wrap-element-attached: Element to wrap with is already attached to tree model.");
                const i = t.root.document ? t.root.document.version : null,
                    o = new ic(t.start, n, i);
                this.batch.addOperation(o), this.model.applyOperation(o);
                const r = new nc(t.start.getShiftedBy(1), t.end.offset - t.start.offset, Hs._createAt(n, 0), null === i ? null : i + 1);
                this.batch.addOperation(r), this.model.applyOperation(r)
            }
            unwrap(t) {
                if (this._assertWriterUsedCorrectly(), null === t.parent) throw new P.b("writer-unwrap-element-no-parent: Trying to unwrap an element which has no parent.");
                this.move(qs._createIn(t), this.createPositionAfter(t)), this.remove(t)
            }
            addMarker(t, e) {
                if (this._assertWriterUsedCorrectly(), !e || "boolean" != typeof e.usingOperation) throw new P.b("writer-addMarker-no-usingOperations: The options.usingOperations parameter is required when adding a new marker.");
                const n = e.usingOperation,
                    i = e.range,
                    o = void 0 !== e.affectsData && e.affectsData;
                if (this.model.markers.has(t)) throw new P.b("writer-addMarker-marker-exists: Marker with provided name already exists.");
                if (!i) throw new P.b("writer-addMarker-no-range: Range parameter is required when adding a new marker.");
                return n ? (fc(this, t, null, i, o), this.model.markers.get(t)) : this.model.markers._set(t, i, n, o)
            }
            updateMarker(t, e = {}) {
                this._assertWriterUsedCorrectly();
                const n = "string" == typeof t ? t : t.name,
                    i = this.model.markers.get(n);
                if (!i) throw new P.b("writer-updateMarker-marker-not-exists: Marker with provided name does not exists.");
                const o = "boolean" == typeof e.usingOperation,
                    r = "boolean" == typeof e.affectsData,
                    s = r ? e.affectsData : i.affectsData;
                if (!o && !e.range && !r) throw new P.b("writer-updateMarker-wrong-options: One of the options is required - provide range, usingOperations or affectsData.");
                const a = i.getRange(),
                    c = e.range ? e.range : a;
                o && e.usingOperation !== i.managedUsingOperations ? e.usingOperation ? fc(this, n, null, c, s) : (fc(this, n, a, null, s), this.model.markers._set(n, c, void 0, s)) : i.managedUsingOperations ? fc(this, n, a, c, s) : this.model.markers._set(n, c, void 0, s)
            }
            removeMarker(t) {
                this._assertWriterUsedCorrectly();
                const e = "string" == typeof t ? t : t.name;
                if (!this.model.markers.has(e)) throw new P.b("writer-removeMarker-no-marker: Trying to remove marker which does not exist.");
            ...
            setSelectionAttribute(t, e) {
                if (this._assertWriterUsedCorrectly(), "string" == typeof t) this._setSelectionAttribute(t, e);
                    ...
                    for (const [e, n] of Rs(t)) this._setSelectionAttribute(e, n)
            }
            ...
            _setSelectionAttribute(t, e) {
                ...
                if (n.isCollapsed && n.anchor.parent.isEmpty) {
                    const i = ea._getStoreAttributeKey(t);
            ...
            _assertWriterUsedCorrectly() {
                if (this.model._currentWriter !== this) throw new P.b("writer-incorrect-use: Trying to use a writer outside the change() block.")
            }
        }
        ...
        function hc(t, e, n, i) {
            ...
            if (s != n) {
                if (i.root === i) {
                    ...
                    const o = (a = new qs(Hs._createBefore(i), t.createPositionAfter(i))).root.document ? r.version : null;
                    c = new tc(a, e, s, n, o)
                }
        ...
        function fc(t, e, n, i, o) {
            const r = t.model,
                s = r.document,
                a = new oc(e, n, i, r.markers, o, s.version);
        ...
        function mc(t, e, n, i) {
            ...
            if (t.root.document) {
                const n = i.document,
                    r = new Hs(n.graveyard, [0]);
                o = new nc(t, e, r, n.version)
            } else o = new ec(t, e);
        ...
        class gc {
                ...
                for (const t of this._changesInElement.keys()) {
                    ...
                    for (const n of r)
                        ...
                        const n = o[s].attributes,
                            r = i[a].attributes;
                        let c;
                        if ("$text" == o[s].name) c = new qs(Hs._createAt(t, s), Hs._createAt(t, s + 1));
                        else {
                            const e = t.offsetToIndex(s);
                            c = new qs(Hs._createAt(t, s), Hs._createAt(t.getChild(e), 0))
                        }
            ...
            _removeAllNestedChanges(t, e, n) {
                const i = new qs(Hs._createAt(t, e), Hs._createAt(t, e + n));
        ...
        class Ac {
            constructor(t) {
                this.model = t, this.version = 0, this.history = new kc(this), this.selection = new ea(this), this.roots = new Xi({
                    idProperty: "rootName"
                }), this.differ = new gc(t.markers), this._postFixers = new Set, this.createRoot("$root", xc), this.listenTo(t, "applyOperation", (t, e) => {
                    const n = e[0];
                    if (n.isDocumentOperation && n.baseVersion !== this.version) throw new P.b("model-document-applyOperation-wrong-version: Only operations with matching versions can be applied.", {
                        operation: n
                    })
                }, {
                    priority: "highest"
            ...
            createRoot(t = "$root", e = "main") {
                if (this.roots.get(e)) throw new P.b("model-document-createRoot-name-exists: Root with specified name already exists.", {
                    name: e
                });
        ...
        class Tc {
            ...
            _set(t, e, n = !1, i = !1) {
                const o = t instanceof Pc ? t.name : t,
                    r = this._markers.get(o);
                if (r) {
                    const t = r.getRange();
                    let s = !1;
                    return t.isEqual(e) || (r._attachLiveRange(Xs.fromRange(e)), s = !0), n != r.managedUsingOperations && (r._managedUsingOperations = n, s = !0), "boolean" == typeof i && i != r.affectsData && (r._affectsData = i, s = !0), s && this.fire("update:" + o, r, t, e), r
                }
                const s = Xs.fromRange(e),
                    a = new Pc(o, s, n, i);
                return this._markers.set(o, a), this.fire("update:" + o, a, null, e), a
            }
            _remove(t) {
                const e = t instanceof Pc ? t.name : t,
        ...
        class Pc {
            ...
            get managedUsingOperations() {
                if (!this._liveRange) throw new P.b("marker-destroyed: Cannot use a destroyed marker instance.");
        ...
        class Mc extends Hs {
            constructor(t, e, n = "toNone") {
                if (super(t, e, n), !this.root.is("rootElement")) throw new P.b("model-liveposition-root-not-rootelement: LivePosition's root has to be an instance of RootElement.");
                (function() {
                    this.listenTo(this.root.document.model, "applyOperation", (t, e) => {
                        const n = e[0];
                        n.isDocumentOperation && function(t) {
            ...
            toPosition() {
                return new Hs(this.root, this.path.slice(), this.stickiness)
            }
        ...
        class Sc {
            ...
            _mergeSiblingsOf(t, e) {
                if (!(t instanceof zs)) return;
                const n = this._canMergeLeft(t, e),
                    i = this._canMergeRight(t, e),
                    o = Mc._createBefore(t);
                o.stickiness = "toNext";
                const r = Mc._createAfter(t);
                if (r.stickiness = "toNext", n) {
                    const t = Mc.fromPosition(this.position);
                    t.stickiness = "toNext", this.writer.merge(o), this.position = t.toPosition(), t.detach()
                }
                if (i) {
                    this.position.isEqual(r) || fs.a.error("insertcontent-wrong-position-on-merge: The insertion position should equal the merge position"), this.position = Hs._createAt(r.nodeBefore, "end");
                    const t = new Mc(this.position.root, this.position.path, "toPrevious");
            ...
            _canMergeLeft(t, e) {
                const n = t.previousSibling;
                return e.isFirst && n instanceof zs && this.canMergeWith.has(n) && this.model.schema.checkMerge(n, t)
            }
            _canMergeRight(t, e) {
                const n = t.nextSibling;
                return e.isLast && n instanceof zs && this.canMergeWith.has(n) && this.model.schema.checkMerge(t, n)
            }
        ...
        function Ic(t, e, n = {}) {
            ...
            t.change(t => {
                ...
                function(t, e) {
                    ...
                    t.remove(t.createRangeIn(n)), Ec(t, t.createPositionAt(n, 0), e)
                }(t, e);
                const o = e.getFirstRange(),
                    r = o.start,
                    s = Mc.fromPosition(o.end, "toNext");
                o.start.isTouching(o.end) || t.remove(o), n.leaveUnmerged || (! function t(e, n, i) {
                        ...
                        t(e, n, i)
                    }(t, r, s), i.removeDisallowedAttributes(r.parent.getChildren(), t)), e instanceof ea ? t.setSelection(r) : e.setTo(r),
                    function(t, e) {
                        const n = t.checkChild(e, "$text"),
                            i = t.checkChild(e, "paragraph");
                        return !n && i
                    }(i, r) && Ec(t, r, e), s.detach()
            })
        }

        function Ec(t, e, n) {
            const i = t.createElement("paragraph");
            t.insert(i, e), n instanceof ea ? t.setSelection(i, 0) : n.setTo(i, 0)
        }
        const Nc = ' ,.?!:;"-()';
        ...
        function Rc(t, e) {
            if ("text" == e.type) return "word" === t.unit ? function(t, e) {
                ...
                if (n) {
                    ...
                    for (; vc(i, o) || "character" == e && yc(i, o);) t.next(), o = t.position.offset - n.startOffset
                }
                return t.position
            }(t.walker, t.unit, t.isForward);
            if (e.type == (t.isForward ? "elementStart" : "elementEnd")) {
                if (t.schema.isObject(e.item)) return Hs._createAt(e.item, t.isForward ? "after" : "before");
        ...
        function zc(t, e) {
            return t.isCollapsed ? function(t, e) {
                ...
                if (o.nodeAfter && e.isLimit(o.nodeAfter)) return new qs(o, Hs._createAfter(o.nodeAfter));
                return new qs(o)
            }(t, e) : function(t, e) {
                const n = t.start,
                    i = t.end,
                ...
                if (s === a) {
                    ...
                    if (function(t, e, n) {
                        ...
                        const t = e.getNearestSelectionRange(n, "forward"),
                            o = e.getNearestSelectionRange(i, "backward");
                        return new qs(t ? t.start : n, o ? o.start : i)
                    }
                }
                const c = s && !s.is("rootElement"),
                    l = a && !a.is("rootElement");
                if (c || l) {
                    const t = Hs._createAt(s, 0),
                        o = Hs._createAt(a, 0),
                        r = c ? Bc(t, e, "start") : n,
                        d = l ? Bc(o, e, "end") : i;
                    return new qs(r, d)
        ...
        function Bc(t, e, n) {
            let i = t.parent,
                o = i;
            for (; e.isLimit(o) && o.parent;) i = o, o = o.parent;
            return "start" === n ? Hs._createBefore(i) : Hs._createAfter(i)
        }
        class Fc {
            constructor() {
            ...
            insertContent(t, e, n) {
                ! function(t, e, n, i) {
                    t.change(o => {
                        let r;
                        (r = n ? n instanceof Js || n instanceof ea ? n : o.createSelection(n, i) : t.document.selection).isCollapsed || t.deleteContent(r);
                        const s = new Sc(t, o, r.anchor);
                        let a;
                        ...
                        c ? r instanceof ea ? o.setSelection(c) : r.setTo(c) : fs.a.warn("insertcontent-no-range: Cannot determine a proper selection range after insertion.")
                    })
                }(this, t, e, n)
            }
            deleteContent(t, e) {
                ...
                return function(t, e) {
                    return t.change(t => {
                        ...
                        if (a != i) {
                            ...
                            jc(t.createRange(e.end, t.createPositionAt(n, "end")), t), jc(o, t)
                        }
                        return n
                    })
                }(this, t)
            ...
            hasContent(t) {
                if (t instanceof zs && (t = qs._createIn(t)), t.isCollapsed) return !1;
            ...
            createPositionAt(t, e) {
                return Hs._createAt(t, e)
            }
            createPositionAfter(t) {
                return Hs._createAfter(t)
            }
            createPositionBefore(t) {
                return Hs._createBefore(t)
            }
            createRange(t, e) {
                return new qs(t, e)
            }
        ...
        class qc {
            constructor(t) {
                ...
                this.config = new T(t, this.constructor.defaultConfig), this.config.define("plugins", e), this.plugins = new ma(this, e), this.commands = new pa, this.locale = new ba(this.config.get("language")), this.t = this.locale.t, this.set("state", "initializing"), this.once("ready", () => this.state = "ready", {
                    priority: "high"
                }), this.once("destroy", () => this.state = "destroyed", {
                    priority: "high"
                }), this.set("isReadOnly", !1), this.model = new Fc, this.data = new za(this.model), this.editing = new fa(this.model), this.editing.view.document.bind("isReadOnly").to(this), this.conversion = new Ba, this.conversion.register("downcast", [this.editing.downcastDispatcher, this.data.downcastDispatcher]), this.conversion.register("editingDowncast", [this.editing.downcastDispatcher]), this.conversion.register("dataDowncast", [this.data.downcastDispatcher]), this.conversion.register("upcast", [this.data.upcastDispatcher]), this.keystrokes = new Hc(this), this.keystrokes.listenTo(this.editing.view.document)
            }
            initPlugins() {
                const t = this,
                    e = this.config;
                return function() {
                    const n = e.get("plugins") || [],
                        ...
                        o = e.get("extraPlugins") || [];
                    return t.plugins.load(n.concat(o), i)
        ...
        var Yc = {
            updateSourceElement() {
                if (!this.sourceElement) throw new P.b("editor-missing-sourceelement: Cannot update the source element of a detached editor.");
                ! function(t, e) {
        ...
        class Gc {
            constructor() {
                this._domParser = new DOMParser, this._domConverter = new er({
                    blockFiller: No
                }), this._htmlWriter = new $c
            }
            toData(t) {
        ...
        class Qc {
            ...
            add(t, e) {
                if (this.has(t)) throw new P.b("componentfactory-item-exists: The item already exists in the component factory.", {
                    name: t
                });
                this._components.set(Jc(t), {
                    callback: e,
                    originalName: t
                })
            }
            create(t) {
                if (!this.has(t)) throw new P.b("componentfactory-item-missing: The required component is not registered in the factory.", {
                    name: t
                });
        ...
        class Kc {
            ...
            add(t) {
                if (this._elements.has(t)) throw new P.b("focusTracker-add-element-already-exist");
        ...
        class tl extends Xi {
            ...
            delegate(...t) {
                if (!t.length || ! function(t) {
                        return t.every(t => "string" == typeof t)
                    }(t)) throw new P.b("ui-viewcollection-delegate-wrong-events: All event names must be strings.");
                return {
                    to: e => {
                        for (const n of this)
        ...
        var el = 1,
            nl = 4;
        var il = function(t, e) {
            return oi(t, el | nl, e = "function" == typeof e ? e : void 0)
        };
        const ol = "http://www.w3.org/1999/xhtml";
        class rl {
            constructor(t) {
            ...
            revert(t) {
                if (!this._revertData) throw new P.b("ui-template-revert-not-applied: Attempting to revert a template which has not been applied yet.");
                this._revertTemplateFromNode(t, this._revertData)
            }* getViews() {
                yield* function* t(e) {
                    if (e.children)
                        for (const n of e.children) _l(n) ? yield n: kl(n) && (yield* t(n))
                }(this)
            }
            static bind(t, e) {
                return {
            ...
            static extend(t, e) {
                t._isRendered && fs.a.warn("template-extend-render: Attempting to extend a template which has already been rendered."),
                    function t(e, n) {
                        ...
                        if (n.children && n.children.length) {
                            if (e.children.length != n.children.length) throw new P.b("ui-template-extend-children-mismatch: The number of children in extended definition does not match.");
                            let i = 0;
            ...
            _renderNode(t) {
                let e;
                if (e = t.node ? this.tag && this.text : this.tag ? this.text : !this.text) throw new P.b('ui-template-wrong-syntax: Node definition must have either "tag" or "text" when rendering a new Node.');
                return this.text ? this._renderText(t) : this._renderElement(t)
            }
            _renderElement(t) {
                let e = t.node;
                return e || (e = t.node = document.createElementNS(this.ns || ol, this.tag)), this._renderAttributes(t), this._renderElementChildren(t), this._setUpListeners(t), e
            }
            _renderText(t) {
                let e = t.node;
            ...
            _renderAttributes(t) {
                ...
                for (e in this.attributes)
                    if (i = r.getAttribute(e), n = this.attributes[e], s && (s.attributes[e] = i), o = it(n[0]) && n[0].ns ? n[0].ns : null, ll(n)) {
                        const a = o ? n[0].value : n;
                        s && yl(e) && a.unshift(i), this._bindToObservable({
                            schema: a,
                            updater: ul(r, e, o),
                            data: t
                        })
                    } else "style" == e && "string" != typeof n[0] ? this._renderStyleAttribute(n[0], t) : (s && i && yl(e) && n.unshift(i), wl(n = n.map(t => t && t.value || t).reduce((t, e) => t.concat(e), []).reduce(gl, "")) || r.setAttributeNS(o, e, n))
            }
            _renderStyleAttribute(t, e) {
                const n = e.node;
                for (const i in t) {
                    const o = t[i];
                    ll(o) ? this._bindToObservable({
                        schema: [o],
                        updater: hl(n, i),
                        data: e
                    }) : n.style[i] = o
            ...
            _bindToObservable({
                ...
                dl(t, e, n);
                const o = t.filter(t => !wl(t)).filter(t => t.observable).map(i => i.activateAttributeListener(t, e, n));
                i && i.bindings.push(o)
            }
        ...
        function dl(t, e, {
            ...
            wl(i = 1 == t.length && t[0] instanceof cl ? i[0] : i.reduce(gl, "")) ? e.remove() : e.set(i)
        }
        ...
        function ml(t) {
            if ("string" == typeof t ? t = function(t) {
                ...
                const e = [];
                if (t.children)
                    if (vl(t.children)) e.push(t.children);
                    else
                        for (const n of t.children) kl(n) || _l(n) || qo(n) ? e.push(n) : e.push(new rl(n));
                t.children = e
            }
            return t
        }
        ...
        class xl {
            constructor(t) {
                this.element = null, this.isRendered = !1, this.locale = t, this.t = t && t.t, this._viewCollections = new Xi, this._unboundChildren = this.createCollection(), this._viewCollections.on("add", (e, n) => {
                    n.locale = t
            ...
            render() {
                if (this.isRendered) throw new P.b("ui-view-render-already-rendered: This View has already been rendered.");
        ...
        class Pl extends xl {
            constructor(t, e) {
                ...
                e && (this.element = this.editableElement = e), this.setTemplate({
                    tag: "div",
                    attributes: {
                        class: ["ck", "ck-content", "ck-editor__editable", "ck-rounded-corners", n.to("isFocused", t => t ? "ck-focused" : "ck-blurred"), n.if("isReadOnly", "ck-read-only")],
        ...
        class El extends xl {
                ...
                this.set("isActive", !1), this.set("isSticky", !1), this.set("limiterElement", null), this.set("limiterBottomOffset", 50), this.set("viewportTopOffset", 0), this.set("_marginLeft", null), this.set("_isStickyToTheLimiter", !1), this.set("_hasViewportTopOffset", !1), this.content = this.createCollection(), this._contentPanelPlaceholder = new rl({
                    ...
                    attributes: {
                        ...
                        style: {
                            ...
                            height: e.to("isSticky", t => t ? Il(this._panelRect.height) : null)
                        }
                    }
                    ...
                    attributes: {
                        ...
                        style: {
                            width: e.to("isSticky", t => t ? Il(this._contentPanelPlaceholder.getBoundingClientRect().width) : null),
                            top: e.to("_hasViewportTopOffset", t => t ? Il(this.viewportTopOffset) : null),
                            bottom: e.to("_isStickyToTheLimiter", t => t ? Il(this.limiterBottomOffset) : null),
            ...
            render() {
                super.render(), this._checkIfShouldBeSticky(), this.listenTo(Ko.window, "scroll", () => {
        ...
        function Ol(t) {
            return !(!t.focus || "none" == Ko.window.getComputedStyle(t.element).display)
        }
        class Rl extends xl {
            constructor(t) {
        ...
        class Dl extends xl {
            ...
            fillFromConfig(t, e) {
                t.map(t => {
                    "|" == t ? this.items.add(new Rl) : e.has(t) ? this.items.add(e.create(t)) : fs.a.warn("toolbarview-item-unavailable: The requested toolbar item is unavailable.", {
                        name: t
                    })
                })
            }
        ...
        class Ll extends Tl {
            constructor(t) {
                super(t), this.stickyPanel = new El(t), this.toolbar = new Dl(t), this.editable = new Ml(t)
            }
            render() {
        ...
        class Vl extends qc {
            constructor(t, e) {
                super(e), tr(t) && (this.sourceElement = t), this._elementReplacer = new jl, this.data.processor = new Gc, this.model.document.createRoot(), this.ui = new Xc(this, new Ll(this.locale)),
                    function(t) {
                        if (!ct(t.updateSourceElement)) throw new P.b("attachtoform-missing-elementapi-interface: Editor passed to attachToForm() must implement ElementApi.");
                        const e = t.sourceElement;
                        if (e && "textarea" === e.tagName.toLowerCase() && e.form) {
                            let n;
                            const i = e.form,
                                o = () => t.updateSourceElement();
                            ct(i.submit) && (n = i.submit, i.submit = (() => {
                                o(), n.apply(i)
            ...
            static create(t, e) {
                return new Promise(n => {
                    ...
                    n(i.initPlugins().then(() => i.ui.init()).then(() => {
                        tr(t) && i._elementReplacer.replace(t, i.element), i.fire("uiReady")
                    }).then(() => i.editing.view.attachDomRoot(i.ui.view.editableElement)).then(() => {
                        const e = tr(t) ? function(t) {
                            return t instanceof HTMLTextAreaElement ? t.value : t.innerHTML
                        }(t) : t;
                        return i.data.init(e)
                    }).then(() => {
                        i.fire("dataReady"), i.fire("ready")
                    }).then(() => i))
                })
            }
        }
        ...
        class Fl extends Jr {
            ...
            onDomEvent(t) {
                const e = {
                    dataTransfer: new Bl(t.clipboardData ? t.clipboardData : t.dataTransfer)
                };
        ...
        class Hl extends zl {
            ...
            init() {
                ...
                this._htmlDataProcessor = new Gc, n.addObserver(Fl), this.listenTo(i, "clipboardInput", e => {
                    t.isReadOnly && e.stop()
                }, {
                    priority: "highest"
                    ...
                    i.content.isEmpty || (i.dataTransfer.setData("text/html", this._htmlDataProcessor.toData(i.content)), i.dataTransfer.setData("text/plain", function t(e) {
                        ...
                        if (e.is("text") || e.is("textProxy")) n = e.data;
                            ...
                            for (const o of e.getChildren()) {
                                const e = t(o);
                                i && (i.is("containerElement") || o.is("containerElement")) && (Ul.includes(i.name) || Ul.includes(o.name) ? n += "\n" : n += "\n\n"), n += e, i = o
                            }
                        }
                        return n
        ...
        class ql {
            constructor(t) {
                this.editor = t, this.set("value", void 0), this.set("isEnabled", !1), this.decorate("execute"), this.listenTo(this.editor.model.document, "change", () => {
                    ...
                    n ? (this.on("set:isEnabled", Wl, {
                        priority: "highest"
                    }), this.isEnabled = !1) : (this.off("set:isEnabled", Wl), this.refresh())
                })
            }
            refresh() {
                this.isEnabled = !0
                ...
                t.change(n => {
                    ! function(t, e, n, i) {
                        ...
                        if (o) $l(e, r.start);
                            ...
                            t.deleteContent(n, {
                                leaveUnmerged: i
                            }), i && (o ? $l(e, n.focus) : e.setSelection(a, 0))
                        }
            ...
            constructor(t) {
                ...
                e.on("keydown", (t, n) => {
                    if (this.isEnabled && n.keyCode == ho.enter) {
                        ...
                        e.once("enter", t => i = t, {
                            priority: "highest"
                        }), e.fire("enter", new Qr(e, n.domEvent, {
                            isSoft: n.shiftKey
        ...
        class Ql extends zl {
            ...
            init() {
                const t = this.editor,
                    e = t.editing.view,
                    n = e.document;
                e.addObserver(Gl), t.commands.add("enter", new Yl(t)), this.listenTo(n, "enter", (n, i) => {
                ...
                t.change(n => {
                    ! function(t, e, n) {
                        ...
                        if (i) Kl(e, o.end);
                            ...
                            t.deleteContent(n, {
                                leaveUnmerged: i
                            }), a ? Kl(e, n.focus) : i && e.setSelection(s, 0)
                        }
        ...
        class Xl extends zl {
            ...
            init() {
                ...
                })), i.addObserver(Gl), t.commands.add("shiftEnter", new Jl(t)), this.listenTo(o, "enter", (e, n) => {
        ...
        class ed extends ql {
            ...
            execute(t = {}) {
                ...
                e.enqueueChange(this._buffer.batch, t => {
                    ...
                    this._buffer.lock(), e || t.remove(r), i && t.insertText(i, n.selection.getAttributes(), r.start), s ? t.setSelection(s) : e && t.setSelection(r.start.getShiftedBy(o)), this._buffer.unlock(), this._buffer.input(o)
                })
            }
        }
        ...
        const id = [fo("arrowUp"), fo("arrowRight"), fo("arrowDown"), fo("arrowLeft"), 9, 16, 17, 18, 19, 20, 27, 33, 34, 35, 36, 45, 91, 93, 144, 145, 173, 174, 175, 176, 177, 178, 179, 255];
        for (let t = 112; t <= 135; t++) id.push(t);

        function od(t) {
            if (0 == t.length) return !1;
            for (const e of t)
                if ("children" === e.type && !rd(e)) return !0;
            return !1
        }
        ...
        function rd(t) {
            ...
            }(Fo(t.oldChildren, t.newChildren, sd), t.newChildren);
        ...
        class ad {
            ...
            handle(t, e) {
                if (od(t)) this._handleContainerChildrenMutations(t, e);
                else
            ...
            _handleContainerChildrenMutations(t, e) {
                ...
                const u = a.map(t => t.is("text") ? t.data : "@").join("").replace(/\u00A0/g, " "),
                    h = c.map(t => t.is("text") ? t.data : "@").join("").replace(/\u00A0/g, " ");
                if (h === u) return;
                const f = Fo(h, u),
                    {
                        firstChangeAt: m,
                ...
                const w = u.substr(m, p),
                    _ = this.editor.model.createRange(this.editor.model.createPositionAt(s, m), this.editor.model.createPositionAt(s, m + g));
            ...
            _handleTextMutation(t, e) {
                ...
                const c = this.editing.view.createPositionAt(t.node, o),
                    ...
                    d = this.editor.model.createRange(l, l.getShiftedBy(s)),
                    u = n.substr(o, r);
                this.editor.execute("input", {
                    text: u,
                    range: d,
        ...
        class dd extends zl {
            ...
            init() {
                const t = this.editor,
                    e = new ed(t, t.config.get("typing.undoStep") || 20);
                t.commands.add("input", e), nd(t),
                    function(t) {
        ...
        class hd extends cr {
            constructor(t) {
                ...
                e.on("keyup", (t, e) => {
                    ...
                    const o = {};
                    if (i.keyCode == ho.delete) o.direction = "forward", o.unit = "character";
                    else {
                        if (i.keyCode != ho.backspace) return;
                        o.direction = "backward", o.unit = "codePoint"
                    }
                    const r = co.isMac ? i.altKey : i.ctrlKey;
                    let s;
                    o.unit = r ? "word" : o.unit, o.sequence = ++n, e.once("delete", t => s = t, {
                        priority: "highest"
                    }), e.fire("delete", new Qr(e, i.domEvent, o)), s && s.stop.called && t.stop()
                })
            }
            observe() {}
        }
        ...
        class pd extends zl {
            ...
            init() {
                const t = this.editor,
                    e = t.editing.view,
                    n = e.document;
                e.addObserver(hd), t.commands.add("forwardDelete", new ud(t, "forward")), t.commands.add("delete", new ud(t, "backward")), this.listenTo(n, "delete", (n, i) => {
        ...
        function yd(t, e, n) {
            ...
            for (; s < t.length;) {
                ...
                const a = e[o],
                    c = vd(n, a, r.getContext(n, a, !0)),
                    l = vd(a, n, r.getContext(a, n, !1));
        ...
        function Td(t, e, n) {
            ...
            if (i == n) return null;
            const o = new qs(t.position, t.position.getShiftedBy(t.howMany));
            return new tc(o, e, i, n, 0)
        }
        ...
        function Md(t, e) {
            ...
            for (let i = 0; i < t.length; i++) {
                const o = t[i],
                    r = new nc(o.start, o.end.offset - o.start.offset, e.isEqual(o.end) ? o.start : e, 0);
                n.push(r);
        ...
        _d(tc, tc, (t, e, n) => {
            if (t.key === e.key) {
                const i = t.range.getDifference(e.range).map(e => new tc(e, t.key, t.oldValue, t.newValue, 0)),
                    o = t.range.getIntersection(e.range);
                return o && n.aIsStrong && i.push(new tc(o, e.key, e.newValue, t.newValue, 0)), 0 == i.length ? [new bd(0)] : i
            }
            return [t]
        }), _d(tc, ic, (t, e) => {
            ...
            return i.isCollapsed || n.push(i), n.map(e => new tc(e, t.key, t.oldValue, t.newValue, t.baseVersion))
        }), _d(tc, nc, (t, e) => {
            return function(t, e) {
                const n = qs._createFromPositionAndShift(e.sourcePosition, e.howMany);
                let i = null,
                    o = [];
            ...
            if (t.shouldReceiveAttributes && t.position.hasSameParentAs(e.range.start) && e.range.containsPosition(t.position)) {
                const i = Td(t, e.key, e.newValue);
                i && n.push(i)
            }
            return n
        }), _d(ic, ic, (t, e, n) => t.position.isEqual(e.position) && n.aIsStrong ? [t] : (t.position = t.position._getTransformedByInsertOperation(e), [t])), _d(ic, nc, (t, e) => (t.position = t.position._getTransformedByMoveOperation(e), [t])), _d(ic, cc, (t, e) => (t.position = t.position._getTransformedBySplitOperation(e), [t])), _d(ic, ac, (t, e) => (t.position = t.position._getTransformedByMergeOperation(e), [t])), _d(oc, ic, (t, e) => (t.oldRange && (t.oldRange = t.oldRange._getTransformedByInsertOperation(e)[0]), t.newRange && (t.newRange = t.newRange._getTransformedByInsertOperation(e)[0]), [t])), _d(oc, oc, (t, e, n) => {
            if (t.name == e.name) {
                if (!n.aIsStrong) return [new bd(0)];
                t.oldRange = e.newRange ? e.newRange.clone() : null
            }
            return [t]
        }), _d(oc, ac, (t, e) => (t.oldRange && (t.oldRange = t.oldRange._getTransformedByMergeOperation(e)), t.newRange && (t.newRange = t.newRange._getTransformedByMergeOperation(e)), [t])), _d(oc, nc, (t, e) => (t.oldRange && (t.oldRange = qs._createFromRanges(t.oldRange._getTransformedByMoveOperation(e))), t.newRange && (t.newRange = qs._createFromRanges(t.newRange._getTransformedByMoveOperation(e))), [t])), _d(oc, cc, (t, e) => (t.oldRange && (t.oldRange = t.oldRange._getTransformedBySplitOperation(e)), t.newRange && (t.newRange = t.newRange._getTransformedBySplitOperation(e)), [t])), _d(ac, ic, (t, e) => (t.sourcePosition.hasSameParentAs(e.position) && (t.howMany += e.howMany), t.sourcePosition = t.sourcePosition._getTransformedByInsertOperation(e), t.targetPosition = t.targetPosition._getTransformedByInsertOperation(e), [t])), _d(ac, ac, (t, e, n) => {
            ...
            const i = qs._createFromPositionAndShift(e.sourcePosition, e.howMany);
            return "remove" == e.type && !n.bWasUndone && t.deletionPosition.hasSameParentAs(e.sourcePosition) && i.containsPosition(t.sourcePosition) ? [new bd(0)] : (t.sourcePosition.hasSameParentAs(e.targetPosition) && (t.howMany += e.howMany), t.sourcePosition.hasSameParentAs(e.sourcePosition) && (t.howMany -= e.howMany), t.sourcePosition = t.sourcePosition._getTransformedByMoveOperation(e), t.targetPosition = t.targetPosition._getTransformedByMoveOperation(e), t.graveyardPosition.isEqual(e.targetPosition) || (t.graveyardPosition = t.graveyardPosition._getTransformedByMoveOperation(e)), [t])
        }), _d(ac, cc, (t, e, n) => {
            ...
            const n = qs._createFromPositionAndShift(t.sourcePosition, t.howMany)._getTransformedByInsertOperation(e, !1)[0];
            ...
            const i = qs._createFromPositionAndShift(t.sourcePosition, t.howMany),
            ...
            for (const t of d) {
                ...
                const n = "same" == U(t.start.getParentPath(), e.getMovedRangeStart().getParentPath()),
            ...
            const o = qs._createFromPositionAndShift(t.sourcePosition, t.howMany);
            ...
            if (o.start.hasSameParentAs(e.splitPosition) && o.containsPosition(e.splitPosition)) {
                ...
                return t = t._getTransformedBySplitOperation(e), Md([new qs(o.start, e.splitPosition), t], i)
            }
            ...
            if (e.graveyardPosition) {
                ...
                t.howMany > 1 && n && r.push(qs._createFromPositionAndShift(e.insertionPosition, 1))
            }
            return Md(r, i)
        }), _d(nc, ac, (t, e, n) => {
            const i = qs._createFromPositionAndShift(t.sourcePosition, t.howMany);
                ...
                if ("remove" == t.type) {
                    if (!n.aWasUndone) {
                        ...
                        let i = e.graveyardPosition.clone(),
                            o = e.targetPosition.clone();
                        t.howMany > 1 && (n.push(new nc(t.sourcePosition, t.howMany - 1, t.targetPosition, 0)), i = i._getTransformedByInsertion(t.targetPosition, t.howMany - 1), o = o._getTransformedByMove(t.sourcePosition, t.targetPosition, t.howMany - 1));
                        const r = e.deletionPosition._getCombined(t.sourcePosition, t.targetPosition),
                            s = new nc(i, 1, r, 0),
                            a = s.getMovedRangeStart().path.slice();
                        a.push(0);
                        const c = new Hs(s.targetPosition.root, a),
                            l = new nc(o, e.howMany, c, 0);
                        return n.push(s), n.push(l), n
                    }
                } else if (1 == t.howMany) return n.bWasUndone ? (t.sourcePosition = e.graveyardPosition.clone(), t.targetPosition = t.targetPosition._getTransformedByMergeOperation(e), [t]) : [new bd(0)];
            const o = qs._createFromPositionAndShift(t.sourcePosition, t.howMany)._getTransformedByMergeOperation(e);
            ...
            return [t]
        }), _d(cc, ic, (t, e) => (t.splitPosition.hasSameParentAs(e.position) && t.splitPosition.offset < e.position.offset && (t.howMany += e.howMany), t.splitPosition = t.splitPosition._getTransformedByInsertOperation(e), t.insertionPosition = cc.getInsertionPosition(t.splitPosition), [t])), _d(cc, ac, (t, e, n) => {
            if (!t.graveyardPosition && !n.bWasUndone && t.splitPosition.hasSameParentAs(e.sourcePosition)) {
                const n = e.graveyardPosition.path.slice();
                n.push(0);
                const i = new Hs(e.graveyardPosition.root, n),
                    o = cc.getInsertionPosition(new Hs(e.graveyardPosition.root, n)),
                    r = new cc(i, 0, null, 0);
                return r.insertionPosition = o, t.splitPosition = t.splitPosition._getTransformedByMergeOperation(e), t.insertionPosition = cc.getInsertionPosition(t.splitPosition), t.graveyardPosition = r.insertionPosition.clone(), t.graveyardPosition.stickiness = "toNext", [r, t]
            }
            ...
            if (t.graveyardPosition) {
                if (i.start.isEqual(t.graveyardPosition) || i.containsPosition(t.graveyardPosition)) {
                    const n = t.splitPosition._getTransformedByMoveOperation(e),
                        i = t.graveyardPosition._getTransformedByMoveOperation(e),
                        o = i.path.slice();
                    o.push(0);
                    const r = new Hs(i.root, o);
                    return [new nc(n, t.howMany, r, 0)]
                }
            ...
            if (t.splitPosition.hasSameParentAs(e.sourcePosition) && i.containsPosition(t.splitPosition)) {
                ...
                return t.howMany -= n, t.splitPosition.hasSameParentAs(e.targetPosition) && t.splitPosition.offset < e.targetPosition.offset && (t.howMany += e.howMany), t.splitPosition = e.sourcePosition.clone(), t.insertionPosition = cc.getInsertionPosition(t.splitPosition), [t]
            }
            return !t.splitPosition.isEqual(e.targetPosition) || "insertAtSource" != n.baRelation && "splitBefore" != n.abRelation ? (e.sourcePosition.isEqual(e.targetPosition) || (t.splitPosition.hasSameParentAs(e.sourcePosition) && t.splitPosition.offset <= e.sourcePosition.offset && (t.howMany -= e.howMany), t.splitPosition.hasSameParentAs(e.targetPosition) && t.splitPosition.offset < e.targetPosition.offset && (t.howMany += e.howMany)), t.splitPosition.stickiness = "toNone", t.splitPosition = t.splitPosition._getTransformedByMoveOperation(e), t.splitPosition.stickiness = "toNext", t.graveyardPosition ? t.insertionPosition = t.insertionPosition._getTransformedByMoveOperation(e) : t.insertionPosition = cc.getInsertionPosition(t.splitPosition), [t]) : (t.howMany += e.howMany, t.splitPosition = t.splitPosition._getTransformedByDeletion(e.sourcePosition, e.howMany), t.insertionPosition = cc.getInsertionPosition(t.splitPosition), [t])
        }), _d(cc, cc, (t, e, n) => {
            ...
            if (e.splitPosition.isEqual(t.insertionPosition) && "splitBefore" == n.baRelation) {
                ...
                n.push(0);
                const i = new Hs(e.insertionPosition.root, n);
        ...
        class Sd extends ql {
            ...
            _restoreSelection(t, e, n) {
                const i = this.editor.model,
                    ...
                    r = [];
                for (const e of t) {
                    const t = Id(e, n).find(t => t.start.root != o.graveyard);
                    t && r.push(t)
                }
                r.length && i.change(t => {
                    t.setSelection(r, {
        ...
        class Od extends zl {
            ...
            init() {
                const t = this.editor;
                this._undoCommand = new Ed(t), this._redoCommand = new Nd(t), t.commands.add("undo", this._undoCommand), t.commands.add("redo", this._redoCommand), this.listenTo(t.model, "applyOperation", (t, e) => {
                    const n = e[0];
        ...
        class Ld extends xl {
            ...
            _getTooltipString(t, e, n) {
                return t ? "string" == typeof t ? t : (n && (n = function(t) {
                    return co.isMac ? po(t).map(t => uo[t.toLowerCase()] || t).reduce((t, e) => t.slice(-1) in lo ? t + e : t + "+" + e) : t
        ...
        class Fd extends zl {
            init() {
                ...
                this._addButton("undo", t("bd"), "CTRL+Z", Vd.a), this._addButton("redo", t("be"), "CTRL+Y", Bd.a)
            }
            _addButton(t, e, n, i) {
                const o = this.editor;
        ...
        class Hd extends zl {
            ...
            add(t) {
                if ("string" != typeof t) throw new P.b("pendingactions-add-invalid-message: The message must be a string.");
                const e = Object.create(Li);
        ...
        class Wd extends zl {
            ...
            init() {
                this.loaders = new Xi, this.loaders.on("add", () => this._updatePendingAction()), this.loaders.on("remove", () => this._updatePendingAction()), this._pendingAction = null, this.set("uploaded", 0), this.set("uploadTotal", null), this.bind("uploadedPercent").to(this, "uploaded", this, "uploadTotal", (t, e) => e ? t / e * 100 : 0)
            }
            getLoader(t) {
        ...
        class Yd {
            constructor(t, e) {
                this.id = I(), this.file = t, this._adapter = e, this._reader = new qd, this.set("status", "idle"), this.set("uploaded", 0), this.set("uploadTotal", null), this.bind("uploadedPercent").to(this, "uploaded", this, "uploadTotal", (t, e) => e ? t / e * 100 : 0), this.set("uploadResponse", null)
            }
            read() {
                if ("idle" != this.status) throw new P.b("filerepository-read-wrong-status: You cannot call read if the status is different than idle.");
            ...
            upload() {
                if ("idle" != this.status) throw new P.b("filerepository-upload-wrong-status: You cannot call upload if the status is different than idle.");
        ...
        const $d = "ckCsrfToken",
            Gd = 40,
            Qd = "abcdefghijklmnopqrstuvwxyz0123456789";
        ...
        function Jd() {
            ...
            return t && t.length == Gd || (t = function(t) {
                let e = "";
                const n = new Uint8Array(t);
                window.crypto.getRandomValues(n);
                for (let t = 0; t < n.length; t++) {
                    const i = Qd.charAt(n[t] % Qd.length);
        ...
        class Kd extends zl {
            ...
            init() {
                ...
                t && (this.editor.plugins.get(Wd).createUploadAdapter = (e => new Zd(e, t, this.editor.t)))
            }
        }
        class Zd {
            constructor(t, e, n) {
            ...
            _initListeners(t, e) {
                const n = this.xhr,
                    i = this.loader,
                    o = (0, this.t)("a") + ` ${i.file.name}.`;
                n.addEventListener("error", () => e(o)), n.addEventListener("abort", () => e()), n.addEventListener("load", () => {
                    const i = n.response;
                    if (!i || !i.uploaded) return e(i && i.error && i.error.message ? i.error.message : o);
                    t({
                        default: i.url
                    })
        ...
        class Xd {
            constructor(t, e, n) {
                ...
                t.model.document.on("change", (n, o) => {
                    ...
                    c && t.model.enqueueChange(t => {
                        const e = t.createPositionAt(a.parent, 0),
                            n = t.createPositionAt(a.parent, c[0].length),
                            o = t.createRange(e, n);
                        t.remove(o), i({
                            match: c
                        })
        ...
        class tu {
            constructor(t, e, n) {
                ...
                e instanceof RegExp ? i = e : r = e, "string" == typeof n ? o = n : s = n, r = r || (t => {
                    ...
                    for (const n of e) t.setAttribute(o, !0, n);
                    ...
                    const l = i.focus.parent,
                        d = function(t) {
                            return Array.from(t.getChildren()).reduce((t, e) => t + e.data, "")
                        }(l).slice(0, i.focus.offset),
                        u = r(d),
                        h = eu(l, u.format, t.model),
                        f = eu(l, u.remove, t.model);
                    h.length && f.length && t.model.enqueueChange(e => {
                        const n = t.model.schema.getValidRanges(h, o);
                        s(e, n);
        ...
        class ou extends zl {
            init() {
                ...
                }), t.commands.add(iu, new nu(t, iu)), t.keystrokes.set("CTRL+B", iu)
            }
        }
        var ru = n(22),
            su = n.n(ru);
            ...
            init() {
                ...
                t.ui.componentFactory.add(au, n => {
                    ...
                    return o.set({
                        ...
                        keystroke: "CTRL+B",
                        tooltip: !0
                    }), o.bind("isOn", "isEnabled").to(i, "value", "isEnabled"), this.listenTo(o, "execute", () => t.execute(au)), o
                })
            }
        }
        const lu = "italic";
        class du extends zl {
            init() {
                ...
                }), t.commands.add(lu, new nu(t, lu)), t.keystrokes.set("CTRL+I", lu)
            }
        }
        var uu = n(23),
            hu = n.n(uu);
        ...
        class mu extends zl {
            init() {
                const t = this.editor,
                    e = t.t;
                t.ui.componentFactory.add(fu, n => {
                    const i = t.commands.get(fu),
                        o = new Ld(n);
                    return o.set({
                        label: e("b"),
                        icon: hu.a,
                        keystroke: "CTRL+I",
                        tooltip: !0
                    }), o.bind("isOn", "isEnabled").to(i, "value", "isEnabled"), this.listenTo(o, "execute", () => t.execute(fu)), o
                })
            }
        }
        ...
        class gu extends ql {
            ...
            execute() {
                const t = this.editor.model,
                    e = t.document,
                    n = t.schema,
                    i = Array.from(e.selection.getSelectedBlocks());
                t.change(t => {
                    if (this.value) this._removeQuote(t, i.filter(bu));
                    else {
                        const e = i.filter(t => bu(t) || _u(n, t));
                        this._applyQuote(t, e)
                    }
                })
            }
            _getValue() {
                const t = pu(this.editor.model.document.selection.getSelectedBlocks());
                return !(!t || !bu(t))
            }
            _checkEnabled() {
                ...
                const t = this.editor.model.document.selection,
                    ...
                    n = pu(t.getSelectedBlocks());
                return !!n && _u(e, n)
            }
            _removeQuote(t, e) {
                wu(t, e).reverse().forEach(e => {
        ...
        class ku extends zl {
            init() {
                const t = this.editor,
                    e = t.model.schema;
                t.commands.add("blockQuote", new gu(t)), e.register("blockQuote", {
                    allowWhere: "$block",
                    allowContentOf: "$root"
                }), e.addChildCheck((t, e) => {
        ...
        class Mu extends ql {
            ...
            execute() {
                ...
                if ("popup" != e && "modal" != e) throw new P.b('ckfinder-unknown-openerMethod: The openerMethod config option must by "popup" or "modal".');
                const n = Object.assign({}, this.editor.config.get("ckfinder.options"));
                n.chooseFiles = !0;
                const i = n.onInit;
        ...
        class Iu extends zl {
            ...
            init() {
                const t = this.editor;
                t.commands.add("ckfinder", new Mu(t))
            }
        }
        const Eu = /^data:(\S*?);base64,/;
        class Nu {
            constructor(t, e, n) {
        ...
        class Du {
            constructor(t, e = Ru) {
                ...
                })(t), this._options = Object.assign({}, Ru, e)
            }
            init() {
                return new Promise((t, e) => {
            ...
            static create(t, e = Ru) {
                return new Du(t, e).init()
            }
        }
        F(Du, Li);
        var Lu = Du;
        ...
        class Vu extends zl {
            ...
            init() {
                const t = this.editor,
                    ...
                    n = e.token,
                    i = e.uploadUrl;
                n && (this._uploadGateway = new Vu._UploadGateway(n, i), t.plugins.get(Wd).createUploadAdapter = (t => new zu(this._uploadGateway, t)))
            }
        }
        class zu {
            constructor(t, e) {
        ...
        Vu._UploadGateway = class {
            ...
            upload(t) {
                return new Ou(t, this._token, this._apiAddress)
            }
        };
        class Bu extends cr {
            constructor(t) {
        ...
        class Uu {
            ...
            add(t, e) {
                ...
                const o = n[0];
                i === o || Hu(i, o) || this.fire("change:top", {
                    oldDescriptor: i,
                    newDescriptor: o,
                    writer: e
                })
        ...
        function Hu(t, e) {
            return t && e && t.priority == e.priority && Wu(t.classes) == Wu(e.classes)
        }

        function qu(t, e) {
            return t.priority > e.priority || !(t.priority < e.priority) && Wu(t.classes) > Wu(e.classes)
        }
        ...
        var Yu = n(26),
            $u = n.n(Yu);
        const Gu = Symbol("isWidget"),
            Qu = Symbol("label"),
            Ju = "ck-widget",
            Ku = "ck-widget_selected";

        function Zu(t) {
            return !!t.is("element") && !!t.getCustomProperty(Gu)
        }

        function Xu(t, e, n = {}) {
            return co.isEdge || e.setAttribute("contenteditable", "false", t), e.addClass(Ju, t), e.setCustomProperty(Gu, !0, t), t.getFillerOffset = ih, n.label && function(t, e, n) {
                    n.setCustomProperty(Qu, e, t)
                    ...
                    const n = e.createUIElement("div", {
                        ...
                        const e = this.toDomElement(t),
                            n = new Rd;
                        return n.set("content", $u.a), n.render(), e.appendChild(n.element), e
                    });
                    e.insert(e.createPositionAt(t, 0), n), e.addClass(["ck-widget_selectable"], t)
                }(t, e),
                function(t, e, n, i) {
                    const o = new Uu;
                    o.on("change:top", (e, o) => {
        ...
        function th(t) {
            const e = t.getCustomProperty(Qu);
            return e ? "function" == typeof e ? e() : e : ""
        }

        function eh(t, e) {
            return e.addClass(["ck-editor__editable", "ck-editor__nested-editable"], t), co.isEdge || (e.setAttribute("contenteditable", t.isReadOnly ? "false" : "true", t), t.on("change:isReadOnly", (n, i, o) => {
        ...
        function nh(t, e) {
            ...
            if (n) return e.createPositionAfter(n);
        ...
        const oh = Symbol("isImage");

        function rh(t) {
            const e = t.getSelectedElement();
            return !(!e || ! function(t) {
                return !!t.getCustomProperty(oh) && Zu(t)
            }(e))
        }
        ...
        function ch(t) {
            ...
            return function(t, e, n) {
                ...
                const n = t.getSelectedElement(),
                    i = !!n && e.isObject(n),
                    o = !![...t.focus.getAncestors()].find(t => e.isObject(t));
                return !i && !o
            }(n, e)
        }
        class lh extends ql {
            refresh() {
                this.isEnabled = ch(this.editor.model)
            }
            execute(t) {
                const e = this.editor.model;
                e.change(n => {
                    const i = Array.isArray(t.source) ? t.source : [t.source];
                    for (const t of i) ah(n, e, {
                        src: t
                    })
                })
            }
        ...
        class dh extends zl {
            init() {
                const t = this.editor,
                    ...
                    n = t.t,
                    i = t.conversion;
                t.editing.view.addObserver(Bu), e.register("image", {
                    isObject: !0,
                    isBlock: !0,
                    allowWhere: "$block",
                    allowAttributes: ["alt", "src", "srcset"]
                }), i.for("dataDowncast").add(aa({
                    model: "image",
                    view: (t, e) => uh(e)
                })), i.for("editingDowncast").add(aa({
                    model: "image",
                    view: (t, e) => (function(t, e, n) {
                        return e.setCustomProperty(oh, !0, t), Xu(t, e, {
                            label: function() {
                ...
                })), i.for("downcast").add(Fu("src")).add(Fu("alt")).add(function() {
                    return e => {
        ...
        class mh extends zl {
            ...
            init() {
                ...
                this._previouslySelected = new Set, this.editor.editing.downcastDispatcher.on("selection", (t, e, n) => {
                    ...
                    for (const t of o.getRanges())
                        for (const e of t) {
                            const t = e.item;
                            Zu(t) && !ph(t, s) && (i.addClass(Ku, t), this._previouslySelected.add(t), s = t, t == r && i.setSelection(o.getRanges(), {
                                fake: !0,
                                label: th(r)
                            }))
                        }
                    ...
                    priority: "low"
                }), t.addObserver(hh), this.listenTo(e, "mousedown", (...t) => this._onMousedown(...t)), this.listenTo(e, "keydown", (...t) => this._onKeydown(...t), {
                    priority: "high"
            ...
            _onMousedown(t, e) {
                ...
                if (function(t) {
                        for (; t;) {
                            if (t && t.is("editableElement") && !t.is("rootElement")) return !0;
                            t = t.parent
                        }
                        return !1
                    }(r)) return;
            ...
            _onKeydown(t, e) {
                const n = e.keyCode,
                    i = n == ho.delete || n == ho.arrowdown || n == ho.arrowright;
                let o = !1;
                ! function(t) {
                    return t == ho.arrowright || t == ho.arrowleft || t == ho.arrowup || t == ho.arrowdown
                }(n) ? ! function(t) {
                    return fo(t) == fh
                }(e) ? n === ho.enter && (o = this._handleEnterKey(e.shiftKey)): o = this._selectAllNestedEditableContent() || this._selectAllContent(): o = this._handleArrowKeys(i), o && (e.preventDefault(), t.stop())
            }
            _handleDelete(t) {
            ...
            _handleEnterKey(t) {
                ...
                if (n && e.schema.isObject(n)) return e.change(e => {
                    ...
                    e.insert(i, n, t ? "before" : "after"), e.setSelection(i, "in")
                }), !0
            }
            ...
            _clearPreviouslySelectedWidgets(t) {
                for (const e of this._previouslySelected) t.removeClass(Ku, e);
        ...
        class gh extends ql {
            refresh() {
                ...
                this.isEnabled = sh(t), sh(t) && t.hasAttribute("alt") ? this.value = t.getAttribute("alt") : this.value = !1
            }
            execute(t) {
                const e = this.editor.model,
                    n = e.document.selection.getSelectedElement();
        ...
        class Th extends xl {
            ...
            render() {
                super.render(), this.keystrokes.listenTo(this.element), vh({
                    view: this
            ...
            _createLabeledInputView() {
                const t = this.locale.t,
                    e = new _h(this.locale, kh);
                return e.label = t("bc"), e.inputView.placeholder = t("bc"), e
            }
        }
        ...
        function Ph({
            ...
            const r = function(t) {
                    for (; t && "html" != t.tagName.toLowerCase();) {
                        if ("static" != Ko.window.getComputedStyle(t).position) return t;
                        t = t.parentElement
                    }
                    return null
                }(t.parentElement),
            ...
            let c, l;
            if (i || o) {
                const t = i && new ks(i).getVisible(),
                    e = o && new ks(Ko.window);
        ...
        class Nh extends xl {
            ...
            _startPinning(t) {
                this.attachTo(t);
                const e = Oh(t.target),
                    n = t.limiter ? Oh(t.limiter) : Eh;
                this.listenTo(Ko.document, "scroll", (i, o) => {
                    const r = o.target,
                        s = e && r.contains(e),
                        a = n && r.contains(n);
            ...
            _stopPinning() {
                this.stopListening(Ko.document, "scroll"), this.stopListening(Ko.window, "resize")
            }
        }

        function Oh(t) {
            return tr(t) ? t : bs(t) ? t.commonAncestorContainer : "function" == typeof t ? Oh(t()) : null
        }

        function Rh(t, e) {
            return t.top - e.height - Nh.arrowVerticalOffset
        }

        function Dh(t) {
            return t.bottom + Nh.arrowVerticalOffset
        }
        Nh.arrowHorizontalOffset = 25, Nh.arrowVerticalOffset = 10, Nh._getOptimalPosition = Ph, Nh.defaultPositions = {
            northArrowSouth: (t, e) => ({
                top: Rh(t, e),
            ...
            northArrowSouthEast: (t, e) => ({
                top: Rh(t, e),
                left: t.left + t.width / 2 - e.width + Nh.arrowHorizontalOffset,
                name: "arrow_se"
            }),
            northArrowSouthWest: (t, e) => ({
                top: Rh(t, e),
                left: t.left + t.width / 2 - Nh.arrowHorizontalOffset,
                name: "arrow_sw"
            }),
            ...
            northWestArrowSouthWest: (t, e) => ({
                top: Rh(t, e),
                left: t.left - Nh.arrowHorizontalOffset,
                name: "arrow_sw"
            }),
            northWestArrowSouthEast: (t, e) => ({
                top: Rh(t, e),
                left: t.left - e.width + Nh.arrowHorizontalOffset,
                name: "arrow_se"
            }),
            ...
            northEastArrowSouthEast: (t, e) => ({
                top: Rh(t, e),
                left: t.right - e.width + Nh.arrowHorizontalOffset,
                name: "arrow_se"
            }),
            northEastArrowSouthWest: (t, e) => ({
                top: Rh(t, e),
                left: t.right - Nh.arrowHorizontalOffset,
                name: "arrow_sw"
            }),
            southArrowNorth: (t, e) => ({
                top: Dh(t),
        ...
        class Lh extends zl {
            ...
            init() {
                this.view = new Nh, this.positionLimiter = (() => {
                    const t = this.editor.editing.view,
            ...
            add(t) {
                if (this.hasView(t.view)) throw new P.b("contextualballoon-add-view-exist: Cannot add configuration of the same view twice.");
                this.visibleView && this.view.content.remove(this.visibleView), this._stack.set(t.view, t), this._show(t)
            }
            remove(t) {
                if (!this.hasView(t)) throw new P.b("contextualballoon-remove-view-not-exist: Cannot remove configuration of not existing view.");
        ...
        class Bh extends zl {
            ...
            _createForm() {
                ...
                this._balloon = this.editor.plugins.get("ContextualBalloon"), this._form = new Th(t.locale), this._form.render(), this.listenTo(this._form, "submit", () => {
                    ...
                    rh(e.selection) ? this._isVisible && function(t) {
                        const e = t.plugins.get("ContextualBalloon");
                        if (rh(t.editing.view.document.selection)) {
                            const n = zh(t);
                            e.updatePosition(n)
                        }
                    }(t) : this._hideForm(!0)
        ...
        class Hh extends xl {
            constructor(t) {
                super(t), this.buttonView = new Ld(t), this._fileInputView = new qh(t), this._fileInputView.bind("acceptedType").to(this), this._fileInputView.bind("allowMultipleFiles").to(this), this._fileInputView.delegate("done").to(this), this.setTemplate({
                    tag: "span",
                    attributes: {
        ...
        function Gh(t) {
            return new Promise(e => {
                fetch(t.getAttribute("src")).then(t => t.blob()).then(n => {
                    const i = function(t, e) {
        ...
        class Zh extends zl {
            constructor(t) {
                super(t), this.placeholder = "data:image/svg+xml;utf8," + encodeURIComponent(Kh.a)
            }
            init() {
            ...
            uploadStatusChange(t, e, n) {
                ...
                if (!n.consumable.consume(e.item, t.name)) return;
                const s = i.plugins.get(Wd),
                    a = r ? e.attributeNewValue : null,
                    c = this.placeholder,
                    l = i.editing.mapper.toViewElement(o),
                    d = n.writer;
                if ("reading" == a) return ef(l, d), void nf(c, l, d);
                if ("uploading" == a) {
                    const t = s.loaders.get(r);
                    return ef(l, d), void(t ? ( of (l, d), function(t, e, n, i) {
                        const o = function(t) {
                            const e = t.createUIElement("div", {
                                class: "ck-progress-bar"
                            });
                            return t.setCustomProperty(Xh, !0, e), e
                        }(e);
                    ...
                    }(l, d, t, i.editing.view)) : nf(c, l, d))
                }
                "complete" == a && s.loaders.get(r) && !co.isEdge && function(t, e, n) {
        ...
        const Xh = Symbol("progress-bar"),
            tf = Symbol("placeholder");
        ...
        function nf(t, e, n) {
            ...
            i.getAttribute("src") !== t && n.setAttribute("src", t, i), rf(e, tf) || n.insert(n.createPositionAfter(i), function(t) {
                const e = t.createUIElement("div", {
                    class: "ck-upload-placeholder-loader"
                });
                return t.setCustomProperty(tf, !0, e), e
            }(n))
        }

        function of (t, e) {
            t.hasClass("ck-image-upload-placeholder") && e.removeClass("ck-image-upload-placeholder", t), sf(t, e, tf)
        }
        ...
        class af {
            ...
            rename(t, e) {
                const n = new mi(t, e.getAttributes(), e.getChildren());
        ...
        class df extends zl {
            ...
            init() {
                ...
                n.extend("image", {
                ...
                }), t.commands.add("imageUpload", new cf(t)), i.for("upcast").add(Da({
                    view: {
                        name: "img",
                        key: "uploadId"
                    },
                    ...
                    })(t.item) && !t.item.getAttribute("uploadProcessed")).map(t => Gh(t.item));
                    i.length && (e.stop(), Promise.all(i).then(e => {
                        const i = new af;
                        for (const t of e)
                            if (t.file) {
                                i.setAttribute("uploadProcessed", !0, t.image);
                                const e = o.createLoader(t.file);
                                e && (i.setAttribute("src", "", t.image), i.setAttribute("uploadId", e.id, t.image))
                            } else i.remove(t.image);
                        t.plugins.get("Clipboard").fire("inputTransformation", n)
                    }))
        ...
        class hf extends ql {
            refresh() {
                const t = this.editor.model,
                    e = pu(t.document.selection.getSelectedBlocks());
                this.value = !!e && e.is("paragraph"), this.isEnabled = !!e && ff(e, t.schema)
            }
            execute(t = {}) {
                const e = this.editor.model,
                    n = e.document;
                e.change(i => {
                    ...
                    for (const t of o) !t.is("paragraph") && ff(t, e.schema) && i.rename(t, "paragraph")
                })
            }
        }
        ...
        class mf extends zl {
            ...
            init() {
                const t = this.editor,
                    e = t.model,
                    n = t.data;
                t.commands.add("paragraph", new hf(t)), e.schema.register("paragraph", {
                    ...
                    if (n.consumable.test(e.viewItem, {
                        ...
                        if (mf.paragraphLikeElements.has(e.viewItem.name)) {
                        ...
                        } else gf(e.viewItem, e.modelCursor, n.schema) && (e = Object.assign(e, pf(e.viewItem, e.modelCursor, n)))
                }, {
                    priority: "low"
                }), n.upcastDispatcher.on("text", (t, e, n) => {
                    e.modelRange || gf(e.viewItem, e.modelCursor, n.schema) && (e = Object.assign(e, pf(e.viewItem, e.modelCursor, n)))
                }, {
                    priority: "lowest"
        ...
        mf.paragraphLikeElements = new Set(["blockquote", "dd", "div", "dt", "h1", "h2", "h3", "h4", "h5", "h6", "li", "p", "td"]);
        class bf extends ql {
            constructor(t, e) {
            ...
            refresh() {
                const t = pu(this.editor.model.document.selection.getSelectedBlocks());
                this.value = !!t && this.modelElements.includes(t.name) && t.name, this.isEnabled = !!t && this.modelElements.some(e => wf(t, e, this.editor.model.schema))
            }
            execute(t) {
                const e = this.editor.model,
                    n = e.document,
                    i = t.value;
                e.change(t => {
                    const o = Array.from(n.selection.getSelectedBlocks()).filter(t => wf(t, i, e.schema));
        ...
        class kf extends zl {
            ...
            init() {
                const t = this.editor,
                    ...
                    n = [];
                for (const i of e) i.model !== _f && (t.model.schema.register(i.model, {
                    inheritAllFrom: "$block"
                }), t.conversion.elementToElement(i), n.push(i.model));
                this._addDefaultH1Conversion(t), t.commands.add("heading", new bf(t, n))
            }
            afterInit() {
                const t = this.editor,
                ...
                e && this.listenTo(e, "afterExecute", (e, i) => {
                    ...
                    n.some(t => o.is(t.model)) && !o.is(_f) && 0 === o.childCount && i.writer.rename(o, _f)
                })
            }
            _addDefaultH1Conversion(t) {
                t.conversion.for("upcast").add(Oa({
                    model: "heading1",
                    view: "h1",
                    converterPriority: E.get("low") + 1
                }))
            }
        }
        class vf {
            constructor(t, e) {
                e && Ei(this, e), t && this.set(t)
            }
        }
        F(vf, Li);
        class yf extends xl {
        ...
        class xf extends xl {
            constructor(t, e, n) {
                ...
                this.buttonView = e, this.panelView = n, this.set("isOpen", !1), this.set("isEnabled", !0), this.set("class"), this.set("panelPosition", "auto"), this.focusTracker = new Kc, this.keystrokes = new Uc, this.setTemplate({
                    tag: "div",
                    attributes: {
                ...
                super.render(), this.listenTo(this.buttonView, "open", () => {
                    ...
                    if (this.isOpen)
                        if ("auto" === this.panelPosition) {
                            const t = xf.defaultPanelPositions;
                            this.panelView.position = Ph({
        ...
        class Tf extends Ld {
            ...
            _createArrowView() {
                const t = new Rd;
                return t.content = Cf.a, t.extendTemplate({
                    attributes: {
        ...
        function Ef(t, e = Tf) {
            const n = new e(t),
                i = new yf(t),
                o = new xf(t, n, i);
            return n.bind("isEnabled").to(o), n instanceof Tf ? n.bind("isOn").to(o, "isOpen") : n.arrowView.bind("isOn").to(o, "isOpen"),
                function(t) {
                    (function(t) {
                        t.on("render", () => {
                            wh({
                    ...
                    function(t) {
                        t.on("execute", e => {
                            e.source instanceof If || (t.isOpen = !1)
                        })
                    }(t),
                    function(t) {
        ...
        function Nf(t, e) {
            const n = t.locale,
                i = t.listView = new Pf(n);
            i.items.bindTo(e).using(({
                type: t,
                model: e
            }) => {
                if ("separator" === t) return new Sf(n);
                if ("button" === t || "switchbutton" === t) {
                    const i = new Mf(n);
                    let o;
                    return (o = "button" === t ? new Ld(n) : new If(n)).bind(...Object.keys(e)).to(e), o.delegate("execute").to(i), i.children.add(o), i
                }
        ...
        class Of extends zl {
            init() {
                ...
                t.ui.componentFactory.add("heading", e => {
                    ...
                    const d = Ef(e);
                    return Nf(d, s), d.buttonView.set({
                        isOn: !1,
                        withText: !0,
                        tooltip: o
                    }), d.extendTemplate({
        ...
        function Df(t, e, n, i) {
            const o = t.document;
            Rf.has(o) || (Rf.set(o, new Map), o.registerPostFixer(t => (function(t, e) {
                const n = Rf.get(t);
                let i = !1;
                for (const [t, o] of n) Lf(e, t, o) && (i = !0);
                return i
            })(o, t))), Rf.get(o).set(e, {
                placeholderText: n,
                checkFunction: i
        ...
        function Lf(t, e, n) {
            ...
            let r = !1;
            if (!i) return !1;
            e.getAttribute("data-placeholder") !== o && (t.setAttribute("data-placeholder", o, e), r = !0);
            ...
            return !i.isFocused && c ? (e.hasClass("ck-placeholder") || (t.addClass("ck-placeholder", e), r = !0), r) : (c && s && s.parent !== e ? e.hasClass("ck-placeholder") || (t.addClass("ck-placeholder", e), r = !0) : e.hasClass("ck-placeholder") && (t.removeClass("ck-placeholder", e), r = !0), r)
        }
        const jf = Symbol("imageCaption");
            ...
            init() {
                ...
                const s = function(t, e) {
                    return n => {
                        ...
                        return n.setCustomProperty(jf, !0, i), Df(t, i, e), eh(i, n)
                    }
                }(e, r("q"));
            ...
            _insertMissingModelCaptionElement(t) {
                ...
                for (const n of e)
                    if ("insert" == n.type && "image" == n.name) {
                        ...
                        if (!Vf(e)) return t.appendElement("caption", e), !0
                    }
            }
        }
        ...
        function im(t = []) {
            return t.map(om).map(t => Object.assign({}, t))
        }

        function om(t) {
            if ("string" == typeof t) {
                const e = t;
                em[e] ? t = Object.assign({}, em[e]) : (fs.a.warn("image-style-not-found: There is no such image style of given name.", {
                    name: e
                }), t = {
                    name: e
                })
        ...
        class sm extends zl {
            get localizedDefaultStylesTitles() {
                ...
                return {
                    "Full size image": t("e"),
                    "Side image": t("f"),
                    "Left aligned image": t("g"),
                    "Centered image": t("h"),
                    "Right aligned image": t("i")
                }
            }
            init() {
        ...
        class am extends zl {
            ...
            init() {
                ...
                e && this.listenTo(e, "show", e => {
                    ...
                    priority: "high"
                }), this._toolbars = new Map, this._balloon = this.editor.plugins.get("ContextualBalloon"), this.listenTo(t.ui, "update", () => {
            ...
            register(t, {
                ...
                const o = this.editor,
                    r = new Dl;
                if (this._toolbars.has(t)) throw new P.b("widget-toolbar-duplicated: Toolbar with the given id was already added.", {
                    toolbarId: t
                });
                r.fillFromConfig(e, o.ui.componentFactory), this._toolbars.set(t, {
                    view: r,
                    visibleWhen: n,
                    balloonClassName: i
                })
        ...
        function cm(t) {
            const e = t.editing.view,
                ...
                i = function(t) {
                    ...
                    for (; n;) {
                        if (n.is("element") && Zu(n)) return n;
                        n = n.parent
                    }
                }(e.document.selection);
            return {
                target: e.domConverter.viewToDom(i),
                positions: [n.northArrowSouth, n.northArrowSouthWest, n.northArrowSouthEast, n.southArrowNorth, n.southArrowNorthWest, n.southArrowNorthEast]
            }
        }
        ...
        function gm(t, e) {
            ...
            return e.setCustomProperty(fm, !0, n), n
        }
        ...
        class Cm extends zl {
            init() {
                ...
                t.model.schema.extend("$text", {
                    ...
                    }), t.conversion.for("dataDowncast").add(ca({
                        model: "linkHref",
                        view: gm
        ...
        class Nm extends xl {
            constructor(t) {
                super(t);
                const e = t.t;
                this.focusTracker = new Kc, this.keystrokes = new Uc, this.previewButtonView = this._createPreviewButton(), this.unlinkButtonView = this._createButton(e("bi"), Sm.a, "unlink"), this.editButtonView = this._createButton(e("bj"), Em.a, "edit"), this.set("href"), this._focusables = new tl, this._focusCycler = new Nl({
                    focusables: this._focusables,
                    focusTracker: this.focusTracker,
                    keystrokeHandler: this.keystrokes,
                    actions: {
            ...
            _createPreviewButton() {
                ...
                }), t.bind("label").to(this, "href", t => t || n("bl")), t.bind("isEnabled").to(this, "href", t => !!t), t.template.tag = "a", t.template.eventListeners = {}, t
            }
        }
        var Om = n(33),
            Rm = n.n(Om);
        ...
        class Lm extends zl {
            ...
            init() {
                const t = this.editor;
                t.editing.view.addObserver(Tm), this.actionsView = this._createActionsView(), this.formView = this._createFormView(), this._balloon = t.plugins.get(Lh), this._createToolbarLinkButton(), this._enableUserBalloonInteractions()
            }
            _createActionsView() {
                const t = this.editor,
                    e = new Nm(t.locale),
            ...
            _createToolbarLinkButton() {
                ...
                t.keystrokes.set(Dm, (t, n) => {
                    ...
                    const i = new Ld(t);
                    return i.isEnabled = !0, i.label = n("s"), i.icon = Rm.a, i.keystroke = Dm, i.tooltip = !0, i.bind("isOn", "isEnabled").to(e, "value", "isEnabled"), this.listenTo(i, "execute", () => this._showUI()), i
                })
            }
        ...
        function jm(t) {
            return t.getAncestors().find(t => (function(t) {
                return t.is("attributeElement") && !!t.getCustomProperty(fm)
            })(t))
        }
        class Vm extends ql {
            constructor(t, e) {
        ...
        function Qm(t, e, n) {
            if (n.consumable.consume(e.viewItem, {
                ...
                const a = function(t, e, n) {
                    ...
                    for (const t of e)
                        if ("ul" == t.name || "ol" == t.name) r = n.convertItem(t, r).modelCursor;
                        else {
                            const e = n.convertItem(t, i.createPositionAt(o, "end")),
                                s = e.modelRange.start.nodeAfter;
                            r = e.modelCursor, s && s.is("element") && !n.schema.checkChild(o, s.name) && !(o = r.parent).is("listItem") && o.nextSibling && o.nextSibling.is("listItem") && (o = o.nextSibling, r = i.createPositionAt(o, "end"))
                        } return r
        ...
        class rp extends zl {
            ...
            init() {
                ...
                t.model.document.registerPostFixer(e => (function(t, e) {
                ...
                })(t.model, e)), n.mapper.registerViewToModelLength("li", sp), e.mapper.registerViewToModelLength("li", sp), n.mapper.on("modelToViewPosition", Zm(n.view)), n.mapper.on("viewToModelPosition", function(t) {
                    return (e, n) => {
                    ...
                    priority: "low"
                }), e.upcastDispatcher.on("element:ul", Jm, {
                    priority: "high"
                }), e.upcastDispatcher.on("element:ol", Jm, {
                    priority: "high"
                }), e.upcastDispatcher.on("element:li", Km, {
                    priority: "high"
                }), e.upcastDispatcher.on("element:li", Qm), t.model.on("insertContent", Xm, {
                    priority: "high"
                }), t.commands.add("numberedList", new Vm(t, "numbered")), t.commands.add("bulletedList", new Vm(t, "bulleted")), t.commands.add("indentList", new Fm(t, "forward")), t.commands.add("outdentList", new Fm(t, "backward"));
            ...
            constructor(t, e) {
                const n = e.providers,
                    ...
                    r = n.concat(i).filter(t => {
                        const e = t.name;
                        return e ? !o.has(e) : (fs.a.warn("media-embed-no-provider-name: The configured media provider has no name and cannot be used.", {
                            provider: t
                        }), !1)
                    });
        ...
        class yp {
            ...
            _getPlaceholderHtml() {
                const t = new Dd,
                    e = new Rd;
                return t.text = this._t("Open media in new tab"), e.content = _p.a, e.viewBox = kp, new rl({
                    tag: "div",
                    attributes: {
            ...
            init() {
                ...
                t.commands.add("mediaEmbed", new bp(t)), e.register("media", {
                    ...
                    view: (t, e) => {
                        ...
                        return function(t, e, n) {
                            return e.setCustomProperty(fp, !0, t), Xu(t, e, {
                                label: n
                            })
                        }(mp(e, r, i, {
        ...
        class Cp extends zl {
            ...
            init() {
                ...
                this.listenTo(t.plugins.get(Hl), "inputTransformation", () => {
                    const t = e.selection.getFirstRange(),
                        n = Mc.fromPosition(t.start);
                    n.stickiness = "toPrevious";
                    const i = Mc.fromPosition(t.end);
                    ...
                    this._timeoutId && (Ko.window.clearTimeout(this._timeoutId), this._positionToInsert.detach(), this._timeoutId = null, this._positionToInsert = null)
                }, {
                    priority: "high"
                })
            }
            _embedMediaBetweenPositions(t, e) {
                ...
                a.isEnabled && (this._positionToInsert = Mc.fromPosition(t), this._timeoutId = Ko.window.setTimeout(() => {
                    n.model.change(t => {
                        this._timeoutId = null, t.remove(o), "$graveyard" !== this._positionToInsert.root.rootName && t.setSelection(this._positionToInsert), a.execute(s), this._positionToInsert.detach(), this._positionToInsert = null
                    })
                }, 100))
            }
        }
        ...
        class Tp extends xl {
            ...
            resetFormStatus() {
                this.urlInputView.errorText = null, this.urlInputView.infoText = null
            }
            _createUrlInput() {
                const t = this.locale.t,
                    e = new _h(this.locale, kh),
                    n = e.inputView;
                return e.label = t("bf"), n.placeholder = "https://example.com", n.on("input", () => {
                    e.infoText = n.element.value ? t("bg") : null
                }), e
            }
            _createButton(t, e, n, i) {
                const o = new Ld(this.locale);
            ...
            init() {
                ...
                t.ui.componentFactory.add("mediaEmbed", i => {
                    const o = new Tp(function(t, e) {
                        ...
                        r = Ef(i);
                    return this._setUpDropdown(r, o, e, t), this._setUpForm(o, r, e), r
                })
            }
        ...
        function Ip(t) {
            return t.replace(/<span(?: class="Apple-converted-space"|)>(\s+)<\/span>/g, (t, e) => 1 === e.length ? " " : Array(e.length + 1).join("Â  ").substr(0, e.length))
        }

        function Ep(t) {
            const e = new DOMParser,
                n = function(t) {
                    return Ip(Ip(t)).replace(/ <\//g, "Â </").replace(/ <o:p><\/o:p>/g, "Â <o:p></o:p>").replace(/>(\s*(\r\n?|\n)\s*)+</g, "><")
                }(function(t) {
            ...
            ! function(t) {
                t.querySelectorAll("span[style*=spacerun]").forEach(t => {
                    ...
                    t.innerHTML = Array(e + 1).join("Â  ").substr(0, e)
                })
            }(i);
        ...
        const Hp = Symbol("isTable");

        function qp(t) {
            return !!t.getCustomProperty(Hp) && Zu(t)
        }
        ...
        function $p(t = {}) {
            return e => e.on("insert:table", (e, n, i) => {
                ...
                i.writer.insert(i.writer.createPositionAt(s, 0), a), r && (c = function(t, e) {
                    return e.setCustomProperty(Hp, !0, t), Xu(t, e, {
                ...
                for (const e of l) {
                    const {
                        row: n,
                        cell: r
                    } = e, s = og(ig(n, d), a, i), c = eg(o.getChild(n), n, s, i);
                    i.consumable.consume(r, "insert"), tg(e, d, i.writer.createPositionAt(c, "end"), i, t)
                }
        ...
        function Gp(t = {}) {
            return e => e.on("insert:tableRow", (e, n, i) => {
                ...
                for (const e of c) {
                    const n = eg(o, a, og(ig(a, l), s, i), i);
                    i.consumable.consume(e.cell, "insert"), tg(e, l, i.writer.createPositionAt(n, "end"), i, t)
                }
            })
        }
        ...
        function Jp(t = {}) {
            ...
            return t => t.on("attribute:headingRows:table", (t, n, i) => {
                ...
                const r = cg(i.mapper.toViewElement(o)),
                ...
                if (a > s) {
                    ...
                    for (const n of t)
                        for (const t of n.getChildren()) Zp(t, "th", i, e);
                    sg("tbody", r, i)
                } else {
                    ag(Array.from(o.getChildren()).filter(({
                        index: t
                    }) => c(t, a - 1, s)).reverse(), og("tbody", r, i), i, 0);
                    const t = new Up(o, {
                            startRow: a ? a - 1 : a,
                            endRow: s - 1
                        }),
        ...
        function Kp(t = {}) {
            ...
            return t => t.on("attribute:headingColumns:table", (t, n, i) => {
                ...
                const r = {
                    ...
                    a = n.attributeNewValue,
                    c = (s > a ? s : a) - 1;
                for (const t of new Up(o)) t.column > c || Xp(t, r, i, e)
            })
        }
        ...
        function Xp(t, e, n, i) {
            const {
                cell: o
            } = t, r = ng(t, e), s = n.mapper.toViewElement(o);
        ...
        function eg(t, e, n, i) {
            let o = i.mapper.toViewElement(t);
            if (!o) {
                i.consumable.consume(t, "insert"), o = i.writer.createContainerElement("tr"), i.mapper.bindElements(t, o);
        ...
        class lg extends zl {
            ...
            insertRows(t, e = {}) {
                ...
                n.change(e => {
                    ...
                    if (n > i && e.setAttribute("headingRows", n + o, t), 0 === i || i === t.childCount) return void dg(e, t, i, o, this.getColumns(t));
                    const r = new Up(t, {
                        endRow: i
                    });
                    let s = 0;
            ...
            insertColumns(t, e = {}) {
                ...
                n.change(e => {
                    ...
                    if (0 === i || r === i) {
                        for (const n of t.getChildren()) ug(o, e, e.createPositionAt(n, i ? "end" : 0));
                        return
                    }
                    const s = new Up(t, {
                        column: i,
            ...
            splitCellVertically(t, e = 2) {
                ...
                n.change(n => {
                    if (r > 1) {
                        ...
                        jp("colspan", s, t, n);
                        const a = {};
                        i > 1 && (a.colspan = i), o > 1 && (a.rowspan = o), ug(r > e ? e - 1 : r - 1, n, n.createPositionAfter(t), a)
                    }
                    if (r < e) {
                        const s = e - r,
                            a = [...new Up(i)],
                        ...
                        const d = {};
                        o > 1 && (d.rowspan = o), ug(s, n, n.createPositionAfter(t), d);
                    ...
                    if (s > 1) {
                        ...
                        for (const {
                            ...
                            if (e >= r + l && t === d && (e + r + l) % c == 0) {
                                ug(1, n, n.createPositionAt(o.getChild(e), s), u)
                            }
                        }
                    }
                    if (s < e) {
                        ...
                        a > 1 && (l.colspan = a), dg(n, o, r + 1, i, 1, l);
        ...
        function dg(t, e, n, i, o, r = {}) {
            for (let s = 0; s < i; s++) {
                const i = t.createElement("tableRow");
                t.insert(i, e, n), ug(o, t, t.createPositionAt(i, "end"), r)
            }
        }
        ...
        class bg extends ql {
            ...
            _getMergeableCell() {
                const t = Lp("tableCell", this.editor.model.document.selection.getFirstPosition());
                if (!t) return;
                const e = this.editor.plugins.get(lg),
        ...
        function Ag(t) {
            t.document.registerPostFixer(e => (function(t, e) {
                ...
                for (const e of n) {
                    let n;
                    "table" == e.name && "insert" == e.type && (n = e.position.nodeAfter), "tableRow" != e.name && "tableCell" != e.name || (n = Lp("table", e.position)), Pg(e) && (n = Lp("table", e.range.start)), n && !o.has(n) && (i = Cg(n, t) || i, i = Tg(n, t) || i, o.add(n))
                }
                return i
            })(e, t))
        }
        ...
        function Mg(t) {
            t.document.registerPostFixer(e => (function(t, e) {
                const n = e.document.differ.getChanges();
                let i = !1;
                for (const e of n) "remove" == e.type && e.position.parent.is("tableCell") && (i = Eg(e.position.parent, t) || i), "insert" == e.type && ("table" == e.name && (i = Sg(e.position.nodeAfter, t) || i), "tableRow" == e.name && (i = Ig(e.position.nodeAfter, t) || i), "tableCell" == e.name && (i = Eg(e.position.nodeAfter, t) || i));
                return i
            })(e, t))
        }
        ...
        class Lg extends zl {
            init() {
                ...
                n.register("table", {
                ...
                }), i.for("upcast").add(zp()), i.for("editingDowncast").add($p({
                    asWidget: !0
                })), i.for("dataDowncast").add($p()), i.for("upcast").add(Oa({
                    model: "tableRow",
                    view: "tr"
                })), i.for("editingDowncast").add(Gp({
                    asWidget: !0
                })), i.for("dataDowncast").add(Gp()), i.for("downcast").add(t => t.on("remove:tableRow", (t, e, n) => {
                    t.stop();
                    const i = n.writer,
                        o = n.mapper,
                    ...
                    priority: "higher"
                })), i.for("upcast").add(Bp("td")), i.for("upcast").add(Bp("th")), i.for("editingDowncast").add(Qp({
                    asWidget: !0
                })), i.for("dataDowncast").add(Qp()), i.attributeToAttribute({
                    model: "colspan",
                    view: "colspan"
                }), i.attributeToAttribute({
                    model: "rowspan",
                    view: "rowspan"
                }), i.for("editingDowncast").add(Kp({
                    asWidget: !0
                })), i.for("dataDowncast").add(Kp()), i.for("editingDowncast").add(Jp({
                    asWidget: !0
                })), i.for("dataDowncast").add(Jp()), Ng(t.model, t.editing), t.commands.add("insertTable", new fg(t)), t.commands.add("insertTableRowAbove", new mg(t, {
                    order: "above"
                })), t.commands.add("insertTableRowBelow", new mg(t, {
                    order: "below"
                })), t.commands.add("insertTableColumnLeft", new pg(t, {
                    order: "left"
                })), t.commands.add("insertTableColumnRight", new pg(t, {
                    order: "right"
                })), t.commands.add("removeTableRow", new _g(t)), t.commands.add("removeTableColumn", new kg(t)), t.commands.add("splitTableCellVertically", new gg(t, {
                    direction: "vertically"
                })), t.commands.add("splitTableCellHorizontally", new gg(t, {
                    direction: "horizontally"
                })), t.commands.add("mergeTableCellRight", new bg(t, {
                    direction: "right"
                    ...
                    direction: "up"
                })), t.commands.add("setTableColumnHeader", new xg(t)), t.commands.add("setTableRowHeader", new vg(t)), Ag(e), Mg(e), this.editor.keystrokes.set("Tab", (...t) => this._handleTabOnSelectedTable(...t), {
                    priority: "low"
            ...
            _getTabHandler(t) {
                ...
                return (n, i) => {
                    ...
                    const d = c === r.childCount - 1,
                        u = a === s.childCount - 1;
                    let h;
                    if (t && u && d && e.plugins.get(lg).insertRows(s, {
                            at: s.childCount
                        }), t && d) {
        ...
        class $g extends zl {
            init() {
                ...
                t.ui.componentFactory.add("insertTable", n => {
                    ...
                    return this._prepareDropdown(e("y"), Ug.a, n, t)
                    ...
                    return this._prepareDropdown(e("ad"), qg.a, n, t)
                    ...
                    return this._prepareDropdown(e("ak"), Yg.a, n, t)
                })
            }
            _prepareDropdown(t, e, n, i) {
                ...
                return Nf(r, a), r.buttonView.set({
                    label: t,
                    icon: e,
                    tooltip: !0
        ...
        class Qg extends Vl {}
        Qg.builtinPlugins = [class extends zl {
            static get requires() {
            ...
            _addListAutoformats() {
                ...
                t.get("bulletedList") && new Xd(this.editor, /^[*-]\s$/, "bulletedList"), t.get("numberedList") && new Xd(this.editor, /^\d+[.|)]\s$/, "numberedList")
            }
            _addBasicStylesAutoformats() {
                const t = this.editor.commands;
                t.get("bold") && (new tu(this.editor, /(\*\*)([^*]+)(\*\*)$/g, "bold"), new tu(this.editor, /(__)([^_]+)(__)$/g, "bold")), t.get("italic") && (new tu(this.editor, /(?:^|[^*])(\*)([^*_]+)(\*)$/g, "italic"), new tu(this.editor, /(?:^|[^_])(_)([^_]+)(_)$/g, "italic")), t.get("code") && new tu(this.editor, /(`)([^`]+)(`)$/g, "code")
            }
            ...
            _addBlockQuoteAutoformats() {
                this.editor.commands.get("blockQuote") && new Xd(this.editor, /^>\s$/, "blockQuote")
            }
        }, class extends zl {
            static get requires() {
                return [ou, cu]
            ...
            init() {
                const t = this.editor;
                this.listenTo(t.plugins.get(Hl), "inputTransformation", (t, e) => {
